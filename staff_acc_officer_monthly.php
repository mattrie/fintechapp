...
<body>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">MONTHLY ACCOUNT OFFICER</h5>
                  ...
                  <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                 ...
                                 <?php 
                       $get_staff   =   $_SESSION['staff_full_name']           
                                        ?>
           
         <form action="staff_acc_officer_monthly.php" method="POST" enctype="multipart/form-data" >
              
         <div class="input-group mb-3">
             
             <input type="hidden" class="form-control" id="autocomplete_staff" name="srch" placeholder="Search Staff Name here"  value="<?php echo $get_staff;?>" autofocus="" required="">
                     
                   <select name="filter_performance"  >
    ...
    <div class="input-group-append">
      <button class="btn btn-warning" id="btnsearch" name="btnsrch" type="submit">SEARCH</button>  
             ...
             <div class="row">                             
                 <div class="col-sm-2">
                                        <a href="staff_acc_officer_monthly.php" class="btn btn-dark">View All</a> 
                                     </div>
                 <div class="col-sm-2">
