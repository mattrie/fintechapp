...
<html>
    <body onload="load_me()">
      ...
      document.getElementById('load_me').click();
        ...
        <i id="load_me" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false">
...
<div class="modal" id="myModal">
 ...
 $weekly_check = $daily_check = $monthly_check =0;
    ...
    echo ' <div class="card">';
     ...
     echo '<table class="table table-bordered table-striped table-sm  table-hover " style="font-size:14px;" align="center">';
...
//         echo '<td style="font-size:20px;">'.number_format($total_ckeck).'<td>';         
     ...
     echo "<td>------</td>";  
      ...
      <div class="modal-footer">
         ...
         <a href="staff_home.php " class="btn btn-danger">Cancel Booking</a>
      </div> 
      </div>
