...
session_start();
    ...
    if (@$_SESSION['store_message_contribution'] != "") {
     echo $_SESSION['store_message_contribution'];
           $_SESSION['store_message_contribution'] = "";
}
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Contribution Statement</h5>
           ...
           <div class="row" >
               ...
               <div class="col-sm-3" >
                   ...
                   <form  action="contribution_statement.php" method="POST" enctype="multipart/form-data">
          ...
          <form action="contribution_statement.php" method="POST" enctype="multipart/form-data">
              ...
              <a style="border-radius: 8px; padding:8px; font-style:italic ; font-size: 18px; background-color:green; color: whitesmoke; cursor: pointer" class="btn" href="contribution_statement.php">VIEW ALL</a> <br>
       ...
       @$name = $_SESSION['store_name'];
        ...
        $sql_state = "SELECT * FROM contribution WHERE name = '$name' ORDER BY id DESC";
            $result22 = mysqli_query($connect, $sql_state);
...
//        PLEASE NOTE THAT YOU HAVE TO USE SOME "\" TO AVOID BRAKE SPACE IN NAMES
       ...
       echo "<a class='btn' style='color: whitesmoke; background-color: green; margin-right: 10px;' href='contribution.php?name=" . $name. "'>Contribute</a>";
//        echo "<a class='btn' style='color: whitesmoke; background-color: red;' href='contribution_withdrawal.php?name=" . $name. "'>Withdraw</a>";
       echo "<br><a href='contribution.php' style='color:blue;'>Click Here for Blank Payment Panel</a>"; 
         echo "</div>";
...
//        echo "<a class='btn' style='color: whitesmoke; background-color: red;' href='contribution_withdrawal.php?name=" . $name. "'>Withdraw</a>";
    ...
    echo '<tbody class="" style="font-family: sans-serif; color:black ; font-weight:bold;">';
           $sql_state2 = "SELECT * FROM members WHERE namee = '$name'";
            $result2 = mysqli_query($connect, $sql_state2);  
         while ($row= mysqli_fetch_assoc($result2)){  
           echo "<tr align = 'center'>";
        echo '<td></td>';
