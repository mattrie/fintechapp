                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Daily Net_worth</h5>
                                            <p class="m-b-0">Financial Status</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                  ...
                  <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                              ...
                              <!--====================SEARCHING STUDENT-->
                                                        ...
                                                        <form action="net_worth.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Trade Money:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text"  placeholder="enter Trade Money" value="0"  onchange="FormatCurrency(this)" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" id="amount" style="width: 250px; border-radius: 5px;" type="text" name="parent" maxlength="11" required >
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" placeholder="enter Cash at Hand" value="0" onchange="FormatCurrency(this)" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" id="perc" style="width: 250px; border-radius: 5px;" required="" name="interest" maxlength="11" required/>
                                                                </div>
                                                            </div>
                                                              
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Total Cash:</label>
                                                                <div class="col-sm-10">
                                                                   <input type="text" placeholder="Total" id="figure" style="width: 250px; border-radius: 5px;" onkeypress="return CheckNumeric()" onclick="FormatCurrency(this)" onkeyup="FormatCurrency(this)" required="" name="figure" readonly=""/>
                                                                </div>
                                                            </div>
   ...
   var perc = $('#perc');         
     $(perc).keyup(function(e){ 
        e.preventDefault();   
         ...
         var cleanNumber = $("#amount").val().split(",").join("");
          var cleanNumber2 = $("#perc").val().split(",").join("");
         var sum = parseInt(cleanNumber) + parseInt(cleanNumber2);
      
       
     
      
     document.getElementById('figure').value =  sum ;
          });
        });  
   </script>
