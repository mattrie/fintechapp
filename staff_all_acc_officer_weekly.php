...
<body>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <form action="staff_all_acc_officer_weekly.php" method="POST" enctype="multipart/form-data" >
    ...
    <div class="input-group-append">
      <button class="btn btn-warning" id="btnsearch" name="btnsrch" type="submit">SEARCH</button>  
             ...
             <div class="row">                             
                 <div class="col-sm-2">
                     <a href="staff_all_acc_officer_weekly.php" class="btn btn-dark">View All</a> 
                                     </div>
                 <div class="col-sm-2">
