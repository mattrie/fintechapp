...
<head>
    <title>Monthly Unearned Income</title>
...
<body>
    ...
    <a href="monthly_unearned_display_general.php" style="border-radius: 8px; padding:8px; font-style:italic ; font-size: 18px; background-color:green; color: whitesmoke; cursor: pointer; margin-left: 60px;">VIEW ALL</a>
          ...
          <script>
             if (window.XMLHttpRequest)
                  ...
                  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
                   ...
                   xmlhttp.open("GET","monthly_unearned_display_general.php",true);
                                 xmlhttp.send();                
...
//            alert('WORKING');
        ...
        if (autocomplete===""){ 
                alert("You must search for name first");
                   ...
                   xmlhttp.open("GET","monthly_unearned_display.php?codename="+autocomplete,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
