...
//           balance > 1 is to avoid repetition
     $result = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE month = '$month' AND year = '$year' AND (equity > '1' OR withdrawequity > '1') ORDER BY id DESC");  
    
    echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">

     <CAPTION><h3 style="font-size:22px; color:black; font-weight:bold;" align="center">'.$month.' - '.$year.' MONTHLY_EQUITY</h3></CAPTION>
        ...
        while  ($row = mysqli_fetch_array($result)){
          ...
          echo   "<tr align='center'>";
           ...
           echo "<td style='color: green;' >" . number_format($row['equity'])."</td>"; 
            ...
            echo "<td ><a style='color: #ff9900;' href='monthly_equity_statement.php?codename=" . $row['codename']. "&name=".$row['name']."&type=".$row['type']."'>View details</a></td>";
            echo "</tr>";
