...
<head>
    <title>Monthly Equity Statement</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Monthly Equity Statement</h5>
...
//        PLEASE NOTE THAT YOU HAVE TO USE SOME "\" TO AVOID BRAKE SPACE IN NAMES
       ...
       echo '<input type="hidden" value=\''. $type .'\' id="type"/>';
           ...
           //////////////////////////////////----------------------------------////////////////////         
            ...
            $sum_equity = mysqli_query($connect, "SELECT SUM(equity) as total FROM monthly_allloan WHERE name = '$name' ");      
...
//               $plus_interest = $row['interest'];  
        ...
        $sum_withdrawequity = mysqli_query($connect, "SELECT SUM(withdrawequity) as total FROM monthly_allloan WHERE name = '$name'");      
...
//            $_SESSION['av_bal']= $available_blance;FOR AJAX
        ...
        echo "<label style='font-size: 22px; font-weight: bold;'>Equity Balance:<br> N ".number_format($equity_balance)."</label>";
        ...
        $sql_state = "SELECT * FROM monthly_allloan WHERE name = '$name' AND (equity > '1' OR withdrawequity > '1') ORDER BY id DESC";
            $result = mysqli_query($connect, $sql_state);
           
            
            echo '<div class="container">';
     echo  '<div class="table-responsive-sm">' ;
                 echo '<CAPTION><h3 align="center" style="font-size:20px; color: black;"> '.$name.' MONTHLY_EQUITY.</h3></CAPTION>';
