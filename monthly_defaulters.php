...
<body>
    ...
    <div id="pcoded" class="pcoded">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Monthly Defaulters</h5>
     ...
     echo     '<div class="table-responsive">';  
                 echo '<CAPTION><h3 align="center" style="font-size:28px; color:black;">SET FOR PENALTY [MONTHLY DEFAULTERS]</h3></CAPTION>';
     ...
     while ($row = mysqli_fetch_assoc($quco111)){
        ...
        $days_remaining = floor($remaining / 86400);  
            ...
            echo "<td>" . $row['namee']."</td>";
              echo "<td>" . $row['monthlycode']."</td>"; 
            echo "<td>" . number_format($row['monthlyindbal'])."</td>"; 
            echo "<td>" . date('jS F Y' ,strtotime($row['monthlyenddate']))."</td>";  
             
          echo "<td ><a style='color:brown;' href='monthly_loan_statement.php?codename=" . $row['monthlycode']. "&name=".$row['namee']."'>View details</a></td>";
