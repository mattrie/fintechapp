...
//        $code = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE name = '$name' ");      
...
//                          }
        ...
        $indbalance = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE name = '$name' AND codename = '$codename'");      
        ...
        $repaycumm = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE name = '$name' AND codename = '$codename'");      
          while  ($row = mysqli_fetch_assoc($repaycumm)){
          $summation_pay_real = $row['repaycumm']; 
//                           $plus_interest = $row['interest'];  
                          }                 
       
 $sql_statement = "INSERT INTO monthly_allloan (name, remarks, codename, date, month, year, district, collector, withdrawsavings, timestamp) VALUES ('$name', 'Savings Withdrawal', '$codename', '$date', '$month', '$year', '$regnum', 'admin', '$parent', '$time_stamp1')";
      ...
      //  *******************************************************************************************************                
            ...
            $sum_savings = mysqli_query($connect, "SELECT SUM(savings) as total FROM monthly_allloan WHERE name = '$name' AND codename = '$codename'");      
...
//               $plus_interest = $row['interest'];  
        ...
        $sum_withdraw = mysqli_query($connect, "SELECT SUM(withdrawsavings) as total FROM monthly_allloan WHERE name = '$name' AND codename = '$codename'");      
...
//         """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""          
            ...
            ////////////THIS IS TO SUM savings
                $total_save = mysqli_query($connect, "SELECT SUM(savings) as total FROM monthly_allloan");      
             ...
             ////////////THIS IS TO SUM withdrawsavings
                $total_withdrawsavings = mysqli_query($connect, "SELECT SUM(withdrawsavings) as total FROM monthly_allloan");      
  ...
  //         """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""          
           ...
           $result2 = mysqli_query($connect, "UPDATE monthly_allloan SET genbalance = '$gen_balance', repaycumm = '$summation_pay_real', indbalance = '$balance', genbalsavings = '$gen_balance_save', indbalsavings = '$savings_balance' WHERE id = '$id'");
...
//                           $plus_interest = $row['interest'];  
 ...
 $sql_statement = "INSERT INTO monthly_allloan (name, remarks, codename, date, month, year, district, collector, withdrawequity, timestamp) VALUES ('$name', 'Equity Withdrawal', '$codename', '$date', '$month', '$year', '$regnum', 'admin', '$parent', '$time_stamp1')";
                     $result = mysqli_query($connect, $sql_statement); 
...
<head>
    <title>Monthly Withdrawal</title>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>WITHDRAW MONTHLY EQUITY</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">
                      <!--====================SEARCHING STUDENT-->
          <form action="monthly_withdrawals.php" method="POST" enctype="multipart/form-data" >
              <center>
...
//                $sql_state1 = "SELECT * FROM monthly_allloan WHERE name = '$get_name' AND codename = '$codename'";
//            $result1 = mysqli_query($connect, $sql_state1);
//              while($row = mysqli_fetch_assoc($result1)){
//             $ind_savings_balance = $row['indbalsavings'];
//                   
//         }
            $_SESSION['ind_savings_balance'] = "";
          
//        LETS GET EQUITY BY SUM    
            $sum_deposit = "SELECT SUM(equity) as total FROM monthly_allloan WHERE name = '$get_name' AND codename = '$codename'";
            $result2 = mysqli_query($connect, $sum_deposit);
              while($row = mysqli_fetch_assoc($result2)){
             $equity = $row['total'];
              }
            
               $sum_withdraw = "SELECT SUM(withdrawequity) as total FROM monthly_allloan WHERE name = '$get_name' AND codename = '$codename'";
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                 <select name="with_type" class="form-control" required>
                                                                                    <option value="" disabled selected hidden>select Withdrawal</option>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                  <input style="padding: 8px;  font-weight: bold;" class="btn btn-danger button-distance" id="update"  type="submit" name="withd"  value="Withdraw" />       
                                                                         ...
                                                                         <a style="margin-left:40px; border-radius: 10px;" class="btn btn-dark" href="monthly_withdrawals.php">Reset</a>
                                                                </div>
