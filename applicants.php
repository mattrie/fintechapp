...
<body>
    ...
    echo '<tbody class="" style="font-family: sans-serif; color:black ; font-weight:bold;">';
     ...
     while ($row = mysqli_fetch_assoc($quco111)){
          ...
          echo "<td ><a style='color:brown;' href='student_search.php?name=" . $row['namee']. "'>Consider</a></td>";
    ...
    echo  "<a style='color:white;' id='oya' href='applicants.php?iddd=" . $row['id']."&name=".$row['namee']."'>Delete</a>";
              echo "</tr>";
            $inc++;
