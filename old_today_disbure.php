         ...
         <div class="input-group-append">
           <button class="btn btn-warning" id="btnsearch" name="btnsrch" type="submit">SEARCH</button>  
                    ...
                    if (isset($_POST['btnsrch'])) {
                      ...
                      $result = mysqli_query($connect, "SELECT * FROM allloan WHERE date = '$date' AND disburseloan > 10 AND NOT remarks = 'wrongly disbursed' AND collector = '$staff_name' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse' ORDER BY  timestamp ASC");
                      $result1 = mysqli_query($connect, "SELECT * FROM weekly_allloan WHERE date = '$date' AND disburseloan > 10 AND NOT remarks = 'wrongly disbursed' AND collector = '$staff_name' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse' ORDER BY  timestamp ASC");
                      $result20 = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE date = '$date' AND disburseloan > 10 AND NOT remarks = 'wrongly disbursed' AND collector = '$staff_name' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse' ORDER BY  timestamp ASC");
                      ...
                      $total_disburseloan = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date='$date' AND collector = '$staff_name' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse'");
                      while ($row = mysqli_fetch_array($total_disburseloan)) {
                        $summation_daily = $row['total'];
                      }

                      ////////////THIS IS TO SUM WEEKLY
                      $total_weekly = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM weekly_allloan WHERE date='$date' AND collector = '$staff_name' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse'");
                      ...
                      ////////////THIS IS TO SUM WEEKLY
                      $total_monthly = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM monthly_allloan WHERE date='$date' AND collector = '$staff_name' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse'");
                      ...
                      $result = mysqli_query($connect, "SELECT * FROM allloan WHERE date = '$output_date'  AND disburseloan > 10 AND remarks = 'loan disbursement' AND (reverse_alert = '' OR reverse_alert IS NULL) ORDER BY  timestamp ASC");
                      $the_error = mysqli_error($connect);
                      // echo "<script>alert('$the_error')</script>";
                      $result1 = mysqli_query($connect, "SELECT * FROM weekly_allloan WHERE date = '$output_date'  AND disburseloan > 10 AND remarks = 'loan disbursement' AND (reverse_alert = '' OR reverse_alert IS NULL) ORDER BY  timestamp ASC");
                      $result22 = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE date = '$output_date'  AND disburseloan > 10 AND remarks = 'loan disbursement' AND (reverse_alert = '' OR reverse_alert IS NULL) ORDER BY  timestamp ASC");
                      $catA = $catB = $catC = 0;
                      echo ' <div class="card card-block table-border-style">';
                      ...
                      ////THIS IS TO VIEW TYPE FOR TODAYS DISBURSEMENT
                    ...
                    } elseif (isset($_POST['type']) && isset($_POST['start']) && isset($_POST['end'])) {
                      $type = $_POST['type'];
                      ...
                      if ($type == "Daily") {
                        ...
                        echo '<div class="table-responsive">';
                        echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">MONEY DISBURSED BETWEEN: [' . date("jS F Y", strtotime($start)) . '] AND [' . date("jS F Y", strtotime($end)) . '] (DAILY)</h3></CAPTION>';
                        echo '<table class="table table-bordered table-striped " align="center">';
                        ...
                        echo '<div class="table-responsive">';
                        echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">MONEY DISBURSED BETWEEN: [' . date("jS F Y", strtotime($start)) . '] AND [' . date("jS F Y", strtotime($end)) . '] (MONTHLY)</h3></CAPTION>';
                        echo '<table class="table table-bordered table-striped " align="center">';
                        ...
                        echo '<div class="table-responsive">';
                        echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">MONEY DISBURSED BETWEEN: [' . date("jS F Y", strtotime($start)) . '] AND [' . date("jS F Y", strtotime($end)) . '] (WEEKLY)</h3></CAPTION>';
                        echo '<table class="table table-bordered table-striped " align="center">';
                    ...
                    } else if (isset($_POST['view_al22']) && isset($_POST['start']) && isset($_POST['end'])) {
                      ...
                      echo '<div class="table-responsive">';
                      echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">MONEY DISBURSED BETWEEN: [' . date("jS F Y", strtotime($start)) . '] AND [' . date("jS F Y", strtotime($end)) . '] </h3></CAPTION>';
                      echo '<table class="table table-bordered table-striped " align="center">';
