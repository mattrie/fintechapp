    ...
    if ($name != "") {
        ...
        if ($loan_type == "Daily Payment") {
            ...
            if ($parent1 > $available_blance) {
                ...
                $sql_statement = "INSERT INTO allloan(name, remarks, repay, interest_pay, interest_reduce, codename, date, month, year, district, collector, timestamp, dob, bookmark_row, branch) VALUES ('$name', 'Reversal Entry', '-$parent', '$minus_interest', '$return_int_bal', '$telephone', '$date', '$month', '$year', '$regnum', 'admin', '$time_stamp1', '$dob', '$bookmark_row', '$branch')";
            ...
            if ($parent1 > $available_blance) {
                ...
                $bookmark_row = rand(10, 100000000);
                $sql_statement = "INSERT INTO monthly_allloan(name, remarks, repay, codename, date, month, year, district, collector, timestamp, bookmark_row , branch) VALUES ('$name', 'Reversal Entry', '-$parent1', '$telephone', '$date', '$month', '$year', '$regnum', 'admin', '$time_stamp1', '$bookmark_row', '$branch')";
...
//        REVERSE INTREST ENTRY IN REVENUE AS WELL;  
                ...
                $sql_sum_repay = mysqli_query($connect, "UPDATE monthly_allloan SET repay_sum = '$summation_pay22' WHERE disburseloan > 1 AND codename='$telephone' AND remarks = 'loan disbursement'");
...
//              
                ...
                $time_stamp1 = date("h:ia", strtotime($time_stamp));
                $bookmark_row = rand(10, 100000000);
                $sql_statement = "INSERT INTO weekly_allloan (name, remarks, repay, codename, date, month, year, district, collector, equity, timestamp, branch) VALUES ('$name', 'Reversal Entry', '-$parent1', '$telephone', '$date', '$month', '$year', '$regnum', 'admin', '-$equity', '$time_stamp1', '$branch')";
                ...
                $sql_statement2 = "INSERT INTO weekly_allloan (name, remarks, codename, date, month, year, district, collector, withdrawsavings, timestamp, bookmark_row, branch) VALUES ('$name', 'Reversal Entry for savings', '$telephone', '$date', '$month', '$year', '$regnum', 'admin', '$save', '$time_stamp1', '$bookmark_row', '$branch')";
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <!--====================SEARCHING STUDENT-->
                                                        <form action="reverse_entry.php" method="POST"
                                                            enctype="multipart/form-data">
                                                            <center>
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control"
                                                                        id="codename" name="srch"
                                                                        value="<?php echo $codename_fly; ?>"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" placeholder="enter Amount"
                                                                        value="" onchange="FormatCurrency(this)"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:40px; border-radius: 10px;"
                                                                        class="btn btn-dark"
                                                                        href="reverse_entry.php">Reset</a>
                                                                </div>
