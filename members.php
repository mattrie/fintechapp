...
if (isset($_POST['Submit'])) {
 // By  Adedokun Adewale Azeez 19th November 2020
    ...
    if ($check_name != "") {
        ...
        $sql_statement = "INSERT INTO members (namee, registered_by, registration_num, addresss, dob, classs, parentt, telephone, mail, religion, login_id, imagess, level, dateofbirth, branch) Values('$name', 'admin','$regnum', '$address','$dob', '$class', '$parent','$telephone', '$mail', '$religion', '$login_id', '$target_file', '$date', '$dateofbirth', '$branch')";
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="members.php" method="POST"
                                                            ...
                                                            <center>
                                                                <div style="width:140px; height:140px;" class="mb-5">
                                                                    <img id="img123" class="myImg" src="#"
                                                                        alt="CLICK 'BROWSE' TO UPLOAD PHOTO"
                                                                    ...
                                                                    <div class="custom-file mb-3" style="width: 200px;">
                                                                        <input type="file" class="custom-file-input"
                                                                            id="customFile" name="fileToUpload"
                                                                            accept="image/*">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select class="form-control" name="branch"
                                                                        id="branch" required>
                                                                        <option value="" hidden disabled selected>Select Branch</option>
                                                                        <?php
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control"
                                                                        placeholder="enter Unit District" name="regnum"
                                                                        id="district_zone" maxlength="18"
                                                                        style="text-transform: uppercase;" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control"
                                                                        placeholder="enter Occupation" type="text"
                                                                        name="parent" maxlength="50" required
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="number"
                                                                        ...
                                                                        name="telephone" maxlength="50" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="number"
                                                                        placeholder="enter BVN" name="mail"
                                                                        maxlength="50">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        name="religion" required="" maxlength="50"
                                                                        placeholder="enter Refree 1 (A must)">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" type="text"
                                                                        name="loginid"
                                                                        placeholder="enter Refree 2 (optional)"
                                                                        maxlength="50">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="date" class="form-control"
                                                                        name="dateofbirth" style="border-radius: 5px;"
                                                                        required="">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
