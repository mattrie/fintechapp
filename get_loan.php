...
// By  Adedokun Adewale Azeez 19th November 2020
        ...
        if ($get_code_result == "") {
            ...
            $sql_statement = "INSERT INTO allloan (name, type, remarks, disburseloan, indbalance, interest, int_perc, interest_reduce, sum_unearned, codename, date, date_format, month, year, district, startdate, enddate, collector, timestamp, dob, insurance_in, divisor, acc_officer, branch, staff_full_name) VALUES ('$name', '$loan_type', 'loan disbursement', '$parent', '$parent', '$figure', '$int_perc', '$figure', '$figure', '$telephone', '$date', '$startdate', '$month', '$year', '$regnum', '$startdate', '$closedate', 'admin', '$time_stamp1', '$group_name', '$insure_figure', '$divisor_for_int_payment', '$acc_officer', '$branch', '$staff_full_name')";
...
//        $result222 = mysqli_query($connect, "UPDATE members SET dailyenddate = '$closedate', dailycode = '$telephone' WHERE namee = '$name'");
            ...
            if ($result == true) {
                ...
                $mssg = "Disbursed->₦$sms_amt_disburseloan Expiry_DT->$sms_output_closedate";
                $laon = "Loan";
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="get_loan.php" method="POST"
                                                            ...
                                                            if (isset($_POST['btnsrch'])) {
                                                                 // By  Adedokun Adewale Azeez 9th August 2020
                                                                $get_name = mysqli_real_escape_string($connect, $_POST['srch']) ;
                                                        ...
                                                        <form action="get_loan.php" method="POST"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" placeholder="%"
                                                                        onchange="FormatCurrency(this)"
                                                                        onkeypress="return CheckNumeric()"
                                                                        onkeyup="FormatCurrency(this)" id="perc"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="number" placeholder="Form Fee"
                                                                        value="500" id="pro_fee"
                                                                        style="width: 120px; border-radius: 5px; margin-top: 0px;"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Insurance
                                                                    %:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" placeholder="%" id="perc1"
                                                                        onchange="FormatCurrency(this)"
                                                                        onkeypress="return CheckNumeric()"
                                                                        onkeyup="FormatCurrency(this)"
                                                                        style="width: 160px; border-radius: 5px;"
                                                                        required="" name="insure_perc" /><br>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" placeholder="insurance"
                                                                        ...
                                                                        onclick="FormatCurrency(this)"
                                                                        onkeyup="FormatCurrency(this)" required=""
                                                                        name="insure_figure" readonly="" /><br>
                                                                </div>
                                                            </div>
