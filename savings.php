    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <div class="pcoded-main-container">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">SAVINGS DATABASE</h5>
                ...
                <div class="col-sm-3">
            <form name="monthyear" action="savings.php" method="POST" enctype="multipart/form-data">
            ...
            <form name="year" action="savings.php" method="POST" enctype="multipart/form-data">
          ...
          <script>
             if (window.XMLHttpRequest)
                  ...
                  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
                   ...
                   xmlhttp.open("GET","savings_magic.php",true);
                                 xmlhttp.send();                
    ...
    $(select_time).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getmonth==="" || getyear===""){ 
            swal({
                   ...
                   xmlhttp.open("GET","savings_month.php?month="+getmonth+"&year="+getyear,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ==4 && xmlhttp.status==200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
    ...
    $(select_year).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getyear===""){ 
            swal({
                   ...
                   xmlhttp.open("GET","savings_year.php?year="+getyear,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ==4 && xmlhttp.status==200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
