...
session_start();
    ...
    $random_pin = rand(10, 1000000);
      ...
      $result = mysqli_query($connect, "UPDATE branch SET name = '$name', address = '$add' WHERE id = '$get_id'");
      $result1 = mysqli_query($connect, "UPDATE allloan SET branch = '$name' WHERE branch = '$old_name'");
      $result2 = mysqli_query($connect, "UPDATE weekly_allloan SET branch = '$name' WHERE branch = '$old_name'");
      $result3 = mysqli_query($connect, "UPDATE monthly_allloan SET branch = '$name' WHERE branch = '$old_name'");
      $result4 = mysqli_query($connect, "UPDATE contribution SET branch = '$name' WHERE branch = '$old_name'");
      $result5 = mysqli_query($connect, "UPDATE revenuexp SET branch = '$name' WHERE branch = '$old_name'");
      $result6 = mysqli_query($connect, "UPDATE members SET branch = '$name' WHERE branch = '$old_name'");
...
//                     printf("Errormessage: %s\n", mysqli_error($connect));
                ...
                swal({
                         title: 'Success!',
                         text: '$name branch is successfully updated!!',
                         icon: 'success',
                        buttons: {
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
         ...
         <div class="input-group mb-3">
             <input type="text" class="form-control" id="autocom_branch" name="srch" placeholder="Search Branch"  required=""   >
...
//          session_start();
      ...
      if (isset($_POST['btnsrch'])){
                ...
                $get_name = $_POST['srch'];
       $sql_state = "SELECT * FROM branch WHERE name = '$get_name'";
          ...
          ?>
                                                        ...
                                                        <form action="edit_branch.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" placeholder="enter Branch Name"  name="name"  value="<?php echo $name; ?>"  maxlength="70"  style="text-transform: uppercase;" required >
                                                                </div>
                                                            </div>
                                                            ...
                                                            <input type="hidden" name="old_name" value="<?php echo $name ?>"/>
                                                             ...
                                                             <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control"  type="text" name="add"  placeholder="enter Branch Address"  value="<?php echo $address; ?>" maxlength="150"   required>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <button style="" type="submit" name="Submit" id="check_duplicate" class="btn btn-success button-distance">UPDATE</button>
                                                                     <a style="margin-left:70px;" class="btn btn-dark" href="edit_branch.php">Reset</a> 
                                                                </div>
