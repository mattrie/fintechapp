...
<?php
        ...
        @$name = $_SESSION['names'];
       @$codename = $_SESSION['check_codename'];
...
//         echo '<div class="col-sm-4" style="margin-left: 0px;">';
//         echo "<p style='font-size:18px; color:black; margin-bottom:30px; margin-left: 55px;'>";
...
//            LETS DO AUTOMATIC REWARD PENALTY
              if($days_remaining < 1 && $available_blance > 0 && $waver == ''){
     ...
     while ($row=mysqli_fetch_array($result)){
          ...
          echo '<input type="hidden" value='. $_SESSION['district'] .' id="district"/>';
            ...
            echo "<td>" .$row['remarks']."</td>";
             ...
             echo "<td>" .number_format($row['indbalance'])."</td>";  
