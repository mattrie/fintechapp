...
//   echo 'Your Login wrong';
 ...
 if(isset($_POST['submit'])){
      ...
      // By  Adedokun Adewale Azeez 1st October 2020
     $username = mysqli_real_escape_string($connect, $_POST['username']) ;
     $password1 = mysqli_real_escape_string($connect, $_POST['password']) ;
             $password = md5($password1);
     $sql_statement= "SELECT * FROM staff WHERE username='$username' AND pass='$password'";
    $result = mysqli_query($connect, $sql_statement);
     ...
     if(mysqli_num_rows($result)){
         while($rows= mysqli_fetch_assoc($result)){
            ...
            $_SESSION['password_staff']= $rows['pass'];
            $_SESSION['staff_full_name']= $rows['namee'];
              $_SESSION['imagess']= $rows['imagess'];
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" action="staff_login.php" method="POST">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="password" name="password" id="pass"  maxlength="20" required="" class="form-control">
                                        <span class="form-bar"></span>
