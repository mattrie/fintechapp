...
<head>
    <title>TODAY'S INTEREST UPFRONT</title>
...
<body>
    ...
    <div id="pcoded" class="pcoded">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Today's Interest Upfront</h5>
       ...
       <div class="row ">  
               ...
               <div class="row">  
    <div  class="col-sm-6">  
        <form name="date_sort" action="today_interest_upfront.php" method="POST" enctype="multipart/form-data">
       ...
       &nbsp; &nbsp; &nbsp; <input type="date" name="start" id="start"/>  <input type="date" name="end" id="end"/>   
        ...
        <center>
            <input type="submit" value="DISPLAY" name="date_sorting" id="date_sorting" class="btn btn-success"/>
                ...
                <form action="today_interest_upfront.php" method="POST" enctype="multipart/form-data" style="width: 600px;">
               ...
               &nbsp; &nbsp;  <a style="" class="btn btn-dark" href="today_interest_upfront.php">View All</a> <br>
             </form>
                     </div>
   ...
   echo ' <div class="card card-block table-border-style">';       
     ...
     echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">INTEREST UPFRONT: '.$date.'</h3></CAPTION>';
...
//            ///////////////////////////BACK DATE ARENA//////////////////////////
              ...
              @$staff_name = $_SESSION['staff_name'];
               ...
               if($staff_name == ""){
                     $inc=1;
         $result = mysqli_query($connect, "SELECT * FROM allloan WHERE date = '$output_date' AND remarks = 'loan disbursement' ORDER BY  timestamp ASC");
     
  echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">';              
     echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">INTEREST UPFRONT [DAILY]: '.$output_date.'</h3></CAPTION>';
     echo '<table class="table table-bordered table-striped  align="center">';
     ...
     while ($row=mysqli_fetch_array($result)){
           ...
           $inc++;
                ...
                ////////////THIS IS TO SUM DAILY
                        $total_repay = mysqli_query($connect, "SELECT SUM(interest) as total FROM allloan WHERE date = '$output_date' AND remarks = 'loan disbursement' ORDER BY  timestamp ASC");      
                          while  ($row = mysqli_fetch_array($total_repay)){
                          $summation_pro_fees = $row['total'];                          
                          }
                          
                 ////////////THIS IS TO SUM DAILY
                        $total_disburse = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date='$output_date' AND remarks = 'loan disbursement'");      
                          while  ($row = mysqli_fetch_array($total_disburse)){
...
//    ---------------------------------------------------------------------------------------------  
   ...
   //    ---------------------------------------------------------------------------------------------     
    ...
    elseif(isset($_POST['date_sorting']) && $_POST['branch'] == ""){ 
        ...
        $result = mysqli_query($connect, "SELECT * FROM allloan WHERE date_format BETWEEN '$start' AND '$end' AND remarks = 'loan disbursement' ORDER BY  timestamp ASC");
     
   echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">';        
     echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">INTEREST UPFRONT BETWEEN: ['. date("jS F Y", strtotime($start)).'] AND ['.date("jS F Y", strtotime($end)).'] [DAILY]</h3></CAPTION>';
     echo '<table class="table table-bordered table-striped  align="center">';
     ...
     while ($row=mysqli_fetch_array($result)){
           ...
           $inc++;
                ...
                ////////////THIS IS TO SUM DAILY
                        $total_repay = mysqli_query($connect, "SELECT SUM(interest) as total FROM allloan WHERE date_format BETWEEN '$start' AND '$end' AND remarks = 'loan disbursement'");      
                          while  ($row = mysqli_fetch_array($total_repay)){
                          $summation_pro_fees = $row['total'];                          
                          }
                       ...
                       ////////////THIS IS TO SUM DAILY
                    $total_disburse = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date_format BETWEEN '$start' AND '$end' AND remarks = 'loan disbursement'");      
                          while  ($row = mysqli_fetch_array($total_disburse)){
                          $summation_disburseloan = $row['total'];                          
                          }                  
        ...
        $result = mysqli_query($connect, "SELECT * FROM allloan WHERE date_format BETWEEN '$start' AND '$end' AND remarks = 'loan disbursement' AND branch = '$branch' ORDER BY  timestamp ASC");
     
   echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">';        
     echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">INTEREST UPFRONT BETWEEN: ['. date("jS F Y", strtotime($start)).'] AND ['.date("jS F Y", strtotime($end)).'] [DAILY] '.$branch.' Branch</h3></CAPTION>';
     echo '<table class="table table-bordered table-striped  align="center">';
     ...
     while ($row=mysqli_fetch_array($result)){
           ...
           $inc++;
                ...
                ////////////THIS IS TO SUM DAILY
                        $total_repay = mysqli_query($connect, "SELECT SUM(interest) as total FROM allloan WHERE date_format BETWEEN '$start' AND '$end' AND remarks = 'loan disbursement' AND branch = '$branch'");      
                          while  ($row = mysqli_fetch_array($total_repay)){
                          $summation_pro_fees = $row['total'];                          
                          }
                       ...
                       ////////////THIS IS TO SUM DAILY
                    $total_disburse = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date_format BETWEEN '$start' AND '$end' AND remarks = 'loan disbursement' AND branch = '$branch'");      
                          while  ($row = mysqli_fetch_array($total_disburse)){
                          $summation_disburseloan = $row['total'];                          
                          }                  
     ...
     $result = mysqli_query($connect, "SELECT * FROM allloan WHERE date = '$date' AND remarks = 'loan disbursement' ORDER BY  timestamp ASC");
     
   echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">';       
     echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">INTEREST UPFRONT [DAILY]: '.$date.'</h3></CAPTION>';
     ...
     while ($row=mysqli_fetch_array($result)){
           ...
           $inc++;
                ...
                ////////////THIS IS TO SUM DAILY
                        $total_repay = mysqli_query($connect, "SELECT SUM(interest) as total FROM allloan WHERE date = '$date' AND remarks = 'loan disbursement' ORDER BY  timestamp ASC");      
                          while  ($row = mysqli_fetch_array($total_repay)){
                          $summation_pro_fees = $row['total'];                          
                          }
                       ...
                       ////////////THIS IS TO SUM DAILY
                        $total_disburse = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date='$date' AND remarks = 'loan disbursement'");      
                          while  ($row = mysqli_fetch_array($total_disburse)){
                          $summation_disburseloan = $row['total'];                          
                          }                  
