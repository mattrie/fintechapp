...
<head>
    <title>Monthly Account Officer</title>
...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">MONTHLY ACCOUNT OFFICERS</h5>
         ...
         <form action="staff_all_acc_officer_monthly.php" method="POST" enctype="multipart/form-data" >
    ...
    <div class="input-group-append">
      <button class="btn btn-warning" id="btnsearch" name="btnsrch" type="submit">SEARCH</button>  
             ...
             <div class="row">                             
                 <div class="col-sm-2">
                                        <a href="staff_all_acc_officer_monthly.php" class="btn btn-dark">View All</a> 
                                     </div>
                 <div class="col-sm-2">
...
//     ====================STAFF AND NON PERFORMING IS SET=====================================================   
        ...
        $result = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE indbalance > 0 AND remarks = 'loan disbursement' AND    (reverse_alert = '' OR reverse_alert IS NULL) AND acc_officer = '$staff_name' ORDER BY id DESC");  
    
   echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">

     <div ><CAPTION><h3 style="font-size:26px; color:black; font-weight:bold;" align="center">'.$staff_name.' ASSIGNED TO MONTHLY CUSTOMERS (NON-PERFORMING)</h3></CAPTION> </div> 
  ...
  <table  class="table table-bordered table-striped table-hover "  align="center">
   ...
   //    ###########################################################################################   
     ...
     $summation_repay11 = $summation_loan11 = 0;
                        $total_repay11 = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE indbalance > 1 AND remarks = 'loan disbursement' AND acc_officer = '$staff_name'");      
...
//     ------------------------------------------------------------------------             
       ...
       ////////////THIS IS TO SUM DAILY
                        $total_daily = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE indbalance > 1 AND remarks = 'loan disbursement' AND acc_officer = '$staff_name'");      
...
//           balance > 1 is to avoid repetition
   ...
   echo ' <div class="card card-block table-border-style">';       
     ...
     <div ><CAPTION><h3 style="font-size:26px; color:black; font-weight:bold;" align="center">'.$staff_name.' ASSIGNED TO MONTHLY CUSTOMERS</h3></CAPTION> </div> 
     ...
     //    ###########################################################################################   
      ///GET ALL DEBTORS FOR MONTHLY
            ////////////THIS IS TO SUM MONTHLY
                        $total_repay11 = mysqli_query($connect, "SELECT SUM(repay_sum) as total FROM monthly_allloan WHERE acc_officer = '$staff_name'");      
                          while  ($row = mysqli_fetch_array($total_repay11)){
                          $summation_repay11_d = $row['total'];                          
                          }
               
       ////////////THIS IS TO SUM MONTHLY
                        $total_daily = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM monthly_allloan WHERE acc_officer = '$staff_name'");      
                          while  ($row = mysqli_fetch_array($total_daily)){
...
//   ^^^^^^^^^^^^^^^     FILTER NON PERFORMING AND STAFF IS NOT SET    ^^^^^^^^^^^^^^^^^^^^^
        ...
        $result = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE indbalance > 0 AND remarks = 'loan disbursement' AND    (reverse_alert = '' OR reverse_alert IS NULL) AND NOT acc_officer = '' ORDER BY id DESC");  
    
   echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">

     <div ><CAPTION><h3 style="font-size:26px; color:black; font-weight:bold;" align="center">ALL ASSIGNED TO MONTHLY CUSTOMERS (NON-PERFORMING)</h3></CAPTION> </div> 
  ...
  <table  class="table table-bordered table-striped table-hover "  align="center">
   ...
   //    ###########################################################################################   
      ///GET ALL DEBTORS FOR MONTHLY
            ////////////THIS IS TO SUM MONTHLY
     $summation_repay11 = $summation_loan11 = 0;
                        $total_repay11 = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE indbalance > 1 AND remarks = 'loan disbursement' AND disburseloan > 0 AND NOT acc_officer = ''");      
                          while  ($row = mysqli_fetch_array($total_repay11)){
...
//     ------------------------------------------------------------------------             
       ...
       ////////////THIS IS TO SUM MONTHLY
                        $total_daily = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE indbalance > 1 AND remarks = 'loan disbursement' AND disburseloan > 0 AND NOT acc_officer = ''");      
                          while  ($row = mysqli_fetch_array($total_daily)){
...
//           balance > 1 is to avoid repetition
   ...
   echo ' <div class="card card-block table-border-style">';       
     ...
     <div ><CAPTION><h3 style="font-size:26px; color:black; font-weight:bold;" align="center">ALL ASSIGNED TO MONTHLY CUSTOMERS</h3></CAPTION> </div> 
  ...
  <table  class="table table-bordered table-striped table-hover "  align="center">
   ...
   //    ###########################################################################################   
      ///GET ALL DEBTORS FOR MONTHLY
            ////////////THIS IS TO SUM MONTHLY
                        $total_repay11 = mysqli_query($connect, "SELECT SUM(repay_sum) as total FROM monthly_allloan WHERE NOT acc_officer = ''");      
                          while  ($row = mysqli_fetch_array($total_repay11)){
                          $summation_repay11_d = $row['total'];                          
                          }
               
       ////////////THIS IS TO SUM MONTHLY
                        $total_daily = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM monthly_allloan WHERE NOT acc_officer = ''");      
                          while  ($row = mysqli_fetch_array($total_daily)){
                          $summation_loan11_d = $row['total'];                          
                          }
