            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="change_adminpass.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="auth-box card">
                              ...
                              <center>      
                                <div  style="width:140px; height:140px;" class="">
...
<!--                                            <div class="forgot-phone text-right f-right">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" name="submit"  class="btn btn-success btn-md btn-block waves-effect waves-light text-center m-b-20">Change Password</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
