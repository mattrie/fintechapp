...
<body>
    ...
    <div id="pcoded" class="pcoded">
     ...
     echo     '<div class="table-responsive">';  
                 echo '<CAPTION><h3 align="center" style="font-size:28px; color:black;">SET FOR PENALTY [DAILY DEFAULTERS]</h3></CAPTION>';
    ...
    echo '<tbody class="" style="font-family: sans-serif; color:black ; font-weight:bold;">';
     ...
     $disburseloan = $row['disburseloan'];
        ...
        $days_remaining = floor($remaining / 86400);  
          ...
          echo "<td ><a style='color:brown;' href='loan_statement.php?codename=" . $row['codename']. "&name=".$row['name']."'>View details</a></td>";
