...
<body>
    ...
    <div id="pcoded" class="pcoded">
     ...
     echo     '<div class="table-responsive" >';   
                 echo '<CAPTION><h3 align="center" style="font-size:28px; color:black;">EXPIRES WITHIN 3 DAYS [DAILY WARNING]</h3></CAPTION>';
    ...
    echo '<tbody class="" style="font-family: sans-serif; color:black ; font-weight:bold;">';
     ...
     $disburseloan = $row['disburseloan'];
        ...
        $days_remaining = floor($remaining / 86400);  
            ...
            echo "<td>" . number_format($row['dailyindbal'])."</td>"; 
            echo "<td>" . date('jS F Y' ,strtotime($row['enddate']))."</td>";  
               echo "<td>" . $days_remaining." day(s)</td>";  
          echo "<td ><a style='color:brown;' href='payment.php?codename=" . $row['codename']. "&name=".$row['name']."'>View details</a></td>";
