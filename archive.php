...
<body>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Finished Transaction</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
    ...
    <form action="archive.php" method="POST" enctype="multipart/form-data" style="margin-bottom: 20px; margin-top: 30px;" >
        <input type="text" class="form-control mb-4"  id="autocomplete" name="group_name" placeholder="Search Name to view Closed Transactions" required=""  >
