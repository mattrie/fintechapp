...
session_start();
         ...
         $message_text = $_POST['message'];
                ...
                $to = "finsoluteinvestment@gmail.com";
            ...
            function fn_resize($image_resource_id,$width,$height) {
                    ...
                    return $target_layer;
                             ...
                             if(isset($_POST['Submit'])){
                               // By  Adedokun Adewale Azeez 24th September 2020
...
//                     printf("Errormessage: %s\n", mysqli_error($connect)); 
                ...
                swal({
                         title: 'Success!',
                         text: 'Thank you $name. Your application has been successfully submitted!!. We will get back to you shortly. Thank you.',
                         icon: 'success',
                        buttons: {
                            confirm : {text:'Ok',className:'sweet-orange'},
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="icofont-envelope"></i><a href="mailto:finsoluteinvestment@gmail.com">finsoluteinvestment@gmail.com</a>
        <a href="tel:+2348025435279"><i class="icofont-phone"></i>08033963904</a>
      </div>
<!--      <div class="social-links float-right">
  ...
  <header id="header">
      ...
      <div class="logo float-left">
        <h1 class="text-light"><a href="index.php"><span><b>FINSOLUTE</b></span></a></h1>
...
<!--          <li class="drop-down"><a href="">Drop Down</a>
          ...
          <li ><a href="" onclick="coll()" data-toggle="modal" data-target="#myModal"><b>[Register For A Loan] </b></a></li>
          <li> <!--++++++++++++++++++++++=======-->      
                      <!--<a href="tel:+2348025435279" class="btn-get-started animate__animated animate__fadeInUp scrollto"><b>CLICK HERE: 08033963904</b></a>-->
      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('assets1/img/slide/slide-1.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                <h2 class="animate__animated animate__fadeInDown"><span>LOAN MONEY</span></h2>
                <p class="animate__animated animate__fadeInUp">Get any form of Loan suitable for your flexibility as well as payment capacity. We offer Daily, Weekly and Monthly lending. Feel free to contact us regarding your choice of product.</p>
          ...
          <div class="carousel-item" style="background-image: url('assets1/img/slide/slide-2.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                <h2 class="animate__animated animate__fadeInDown">INVEST WISELY</h2>
                <p class="animate__animated animate__fadeInUp">Our investment platform offers a great opportunity of optimum return. All returns are paid in due time without delay. You stand the chance of getting a good interest rate for your investment at all times. Choose FINSOLUTE for your investment!!! <p>
          ...
          <div class="carousel-item" style="background-image: url('assets1/img/slide/slide-3.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                <h2 class="animate__animated animate__fadeInDown">ONLINE APPLICATION</h2>
                <p class="animate__animated animate__fadeInUp">From anywhere, you can apply for a loan and get response in a short time. Click the registration button to apply for a specific amount. Please note that all application is subject to review and subsequent invitation to FINSOLUTE INVESTMENT office.</p>
             <a href="#"  class="btn btn-success  btn-round-full text-white animation" id="menu2" data-toggle="modal" data-target="#myModal" ><b>Register For A Loan </b></a>
            </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="col-lg-6 video-box">
              <img src="assets1/img/abt.jpeg" style=" padding-top: 50px;" class="img-fluid" alt="">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
            ...
            <div class="section-title">
              <h2>About Us</h2>
              <p>We are a team of dedicated experts who seek to proffer financial support to the society at at large. Established for more than a decade, we major in financial support as well as meeting the demands of the populace regarding qualitative and excellent service on a digital platform. </p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bx bx-fingerprint"></i></div>
              <h4 class="title"><a href="">Mission</a></h4>
              <p class="description">To proffer seamless financial support by giving our customers the best services.</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bx bx-gift"></i></div>
              <h4 class="title"><a href="">Vision</a></h4>
              <p class="description">To be the No. 1 Micro Finance Bank in West Africa and the world at large.</p>
            </div>
...
<!--          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 text-center" data-aos="fade-up" data-aos-delay="400">
            <div class="count-box">
              <i class="icofont-ui-check" style="color: #46d1ff;"></i>
...
<!--              <div class="col-lg-3 col-md-6 icon-box" data-aos="fade-up" data-toggle="modal" data-target="#myModal_save" style="cursor: pointer;">
          ...
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300" data-toggle="modal" data-target="#myModal_invest" style="cursor: pointer;">
            ...
            <h4 class="title">Investment Management</h4>
            <p class="description"></p>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up">
            <div class="member">
                <div class="pic"><img src="assets1/img/team/fin_image.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h6>Mr. Gabriel</h6>
                <span>C.E.O Finsolute Investment</span>
<!--                <div class="social">
          ...
          <div class="col-xl-9 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
               
                <p style="text-align: left;">
                    &nbsp;&nbsp;&nbsp;&nbsp;Mr. Gabriel is man of vast experience in the financial sector. He has worked in various financial institution  and indeed proven to deliver the best in accomplishing various forms of task. A tech savvy who has also revolutionize fin-tech methodologies and its practical applications.  
                  <br>   <br> &nbsp;&nbsp;&nbsp;&nbsp;A man of principle and immense dignity who established FINSOLUTE few years back and now it has grown beyond its initial start-off and still growing with more featured service offered  with a profound sense of hospitality.
                </p>
...
<!--          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
                <div class="pic"><img src="assets1/img/team/sec.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Mrs. Moturayo Akinde</h4>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
                <div class="pic"><img src="assets1/img/team/registrar.jpeg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Mr. Samson Adedapo</h4>
                <span>Treasurer</span>
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
        ...
        <div class="row  d-flex align-items-stretch">
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up">
            ...
            <p style="text-align: justify">
                You can apply in person by coming over to Finsolute Investment Office or apply on line by clicking the registration button, then wait shortly for a response.
            </p>
          </div>

          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="100">
            <h4>How Long does it take to process a loan?</h4>
            <p style="text-align: justify">
                This depends on the availability of all valid credentials, as well as loan history to determine your credit worthiness. 
            </p>
          </div>

          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="200">
            <h4>How do I become an investor?</h4>
            <p style="text-align: justify">
          Our investment opportunity offers one of the most secured and guaranteed returns at when due than other investments out there. Your rate of return will be presented based on your investment amount. Please feel free to contact us for further enquiries.     </p>
          </div>

          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="300">
            <h4>Which days is your office opened?</h4>
            <p>
                You can visit us with contact supplied below from Monday - Friday, except for public holidays and festive periods. You can still reach us with phone numbers supplied below.
            </p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="info-box">
              <i class="bx bx-map"></i>
              <h3>Our Address</h3>
              <p>Oluwapo plaza, beside Jankara Bus/stop, Agbado-Ijiaye Road, Lagos.</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="info-box">
              ...
              <h3>Email Us</h3>
              <p>finsoluteinvestment@gmail.com </p>
            </div>
          </div>
...
//          setTimeout(function() {document.getElementById("menu2").click(); }, 1000);
       ...
       <div class="modal fade" id="myModal_estate">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
            <p>
                Landed property is an inevitable investment in this present dispensation, we cater for your housing needs either rental, sales or lease. Finsolute will help you secure all you need.
            </p>
           </div>
              <div class="modal-footer">
                <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
       ...
       <div class="modal fade" id="myModal_gas">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
              <h4 class="modal-title">Oil and Gas</h4>
            </div>
            <div class="modal-body">
            <p>
                 We also specialize in the supply cooking gas (Liquified Petroleuum Gas). We supply in both large and small quantity, meeting targets at scheduled time.
             </p>
           </div>
              <div class="modal-footer">
                <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
       ...
       <div class="modal fade" id="myModal_invest">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
              <h4 class="modal-title">Investment Management</h4>
            </div>
            <div class="modal-body">
            <p>
         Our investment platform offers a great opportunity of optimum return. All returns are paid in due time without delay. You stand the chance of getting a good interest rate for your investment at all times. Choose FINSOLUTE for your investment!!!  </p>
           </div>
              <div class="modal-footer">
                <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
                   <button style="margin-left: 0px;" data-dismiss="modal" class="btn btn-danger float-right" >Close</button>
  ...
  <footer id="footer" >
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>FINSOLUTE</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
