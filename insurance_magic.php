...
//           balance > 1 is to avoid repetition
     $result = mysqli_query($connect, "SELECT * FROM allloan WHERE insurance_in > '1' OR insurance_out ORDER BY id DESC");  
     $result11 = mysqli_query($connect, "SELECT * FROM weekly_allloan WHERE insurance_in > '1' OR insurance_out ORDER BY id DESC");  
      $result22 = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE insurance_in > '1' OR insurance_out ORDER BY id DESC");  
    
     echo '<div class="card card-block table-border-style">';
     
     echo     '<div class="table-responsive">
     <CAPTION><h3 style="font-size:24px; color:black; font-weight:bold;" align="center">INSURANCE LEDGER</h3></CAPTION>
         ...
         $sum_insurance_in3 = mysqli_query($connect, "SELECT SUM(insurance_in) as total_in FROM monthly_allloan");
           ...
           echo "<td style='color: green;' >" . number_format($final_insurance_in)."</td>"; 
            echo "<td style='color: red;' >" . number_format($final_insurance_out)."</td>"; 
               echo "<td style='color: green; font-size: 18px;'  >" . number_format($final_total_insurance)."</td>"; 
              echo "<td >------------</td>";  
           echo "</tr>";             
