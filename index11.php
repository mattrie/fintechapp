<?php
     ...
     $target_dir12 = "client/images/";// this is the directory to upload to
                   //get file name and set to target directory
               $target_file1 = @($target_dir1 . basename($_FILES["fileToUpload1"]["name"]));
                 //....................................
                $target_file12 = @($target_dir12 . basename($_FILES["fileToUpload1"]["name"]));
...
//                                $mail = $_POST['mail'];
        ...
        copy($target_file, $target_file2);  
          ...
          copy($target_file1, $target_file12);  
          ...
          <div class="carousel-item" style="background-image: url('assets1/img/slide/slide-3.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <p class="animate__animated animate__fadeInUp">From anywhere, you can apply for a loan and get response in a short time. Click the registration button to apply for a specific amount. Please note that all application is subject to review and subsequent invitation to FINSOLUTE office.</p>
             <a href="#"  class="btn btn-success  btn-round-full text-white animation" id="menu2" data-toggle="modal" data-target="#myModal" ><b>Register For A Loan </b></a>
            </div>
            </div>
          </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
            ...
            <div class="section-title">
              <h2>About Us</h2>
              <p>We are a team of dedicated experts who seek to proffer financial solution to the society at at large. Established for the seven years, we cover major areas in our service delivery as well as meeting the demands for qualitative and excellent service on a digital platform. </p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bx bx-fingerprint"></i></div>
              <h4 class="title"><a href="">Mission</a></h4>
              <p class="description">To proffer seamless financial solution by giving our customers the best services</p>
            </div>
          ...
          <div class="col-xl-9 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
                ...
                <p style="text-align: left;">
                  ...
                  <br>   <br> &nbsp;&nbsp;&nbsp;&nbsp;A man of principle and immense dignity, established FINSOLUTE few years back, but it has grown beyond its initial start-off and still growing with more featured service offered  with a profound sense of hospitality.
                </p>
      ...
      <div class="container">
        ...
        <div class="row  d-flex align-items-stretch">
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="100">
            ...
            <p style="text-align: justify">
                This depends on the availability of all valid credentials, as well loan history to determine your credit worthiness. 
            </p>
          </div>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="200">
            ...
            <p style="text-align: justify">
          Our investment opportunity offers one of the most secured and guaranteed returns at when due than other investment out there. Your rate of return will be presented based on your investment amount. Please feel free to contact us for further enquiries.     </p>
          </div>

          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="300">
            <h4>Which days is your office opened?</h4>
            <p>
                You can visit with contact supplied below from Monday - Friday, except for public holidays and festive periods. You can still reach us with phone numbers below.
            </p>
          </div>
...
//          setTimeout(function() {document.getElementById("menu2").click(); }, 1000);
       ...
       <div class="modal fade" id="myModal_estate">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
            <p>
                Landed property is an inevitable investment in this present dispensation cater for your housing needs either rental, sales or lease. Finsolute will help you secure all you need.
            </p>
           </div>
              <div class="modal-footer">
                <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
  ...
  <footer id="footer" >
    ...
    <div class="container">
      ...
      <div class="credits">
          Designed by <a href="https://easymaster.com.ng/">EasyMaster <i></i></a>
      </div>
    </div>
  </footer><!-- End Footer -->
