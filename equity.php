                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Weekly Equity</h5>
          ...
          <script>
             if (window.XMLHttpRequest)
                  ...
                  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
                   ...
                   xmlhttp.open("GET","equity_magic.php",true);
                                 xmlhttp.send();                
    ...
    $(select_time).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getmonth==="" || getyear===""){ 
            swal({
                   ...
                   xmlhttp.open("GET","equity_month.php?month="+getmonth+"&year="+getyear,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
    ...
    $(select_year).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getyear===""){ 
              swal({
                   ...
                   xmlhttp.open("GET","equity_year.php?year="+getyear,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
