...
//             @header("location:staff_monthly_payment.php");
//         }
//    ob_start();
//session_start();
...
if (isset($_POST['pay'])) {
    ...
    if ($name != "") {
        // By  Adedokun Adewale Azeez 21st October 2020
...
//                     $date_test =  date('Y-m-d', strtotime($date));
        ...
        $r_tomorrow = $dated - time();
        $days_remaining22 = floor($r_tomorrow / 86400);
        //           !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!     

        if ($days_remaining > 21 || $r_tomorrow > 0) {
            echo "<script type='text/javascript'> $(document).ready(function(){ 
                swal({
                         title: 'Not Allowed!',
                         text: 'You are not permitted to post any money collected less than a day backwards OR fastforward any payments as well. Please, contact the admin!!!',
                         icon: 'error',
                        buttons: {
...
//                         $parent = $parent2 - $interest_to_revenue;
                ...
                if ($pay_pen == "P") {
                    ...
                    $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date, date_format, month, year, collector, branch) VALUES('$name monthly Penalty', 'penalty_monthly', 'monthly', '$parent2', '$date', '$date_format', '$month','$year', '$staff_name', '$branch')");
                    ...
                    $sql_statement = "INSERT INTO monthly_allloan (name, type, remarks, repay, interest, codename, date, date_format, month, year, district, collector, timestamp, bookmark_row, branch) VALUES ('$name', '$loan_type', 'Penalty Paid', '$parent2', '0', '$telephone', '$date', '$date_format', '$month', '$year', '$regnum', '$staff_name', '$time_stamp1', '$bookmark_row', '$branch')";
...
//                $interest_reduce  =  $interest - $sum_interest_pay;
                ...
                swal({
                    ...
                    $staff_name = $_SESSION['staff_full_name'];
                    $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date, date_format, month, year, collector, branch) VALUES('$name monthly interest', 'interest_monthly', 'monthly', '$real_interest', '$date', '$date_format', '$month','$year','$staff_name', '$branch')");
                    ...
                    $bookmark_row = rand(10, 100000000);
                    $sql_statement = "INSERT INTO monthly_allloan (name, type, remarks, repay, interest, codename, date , date_format, month, year, district, collector, timestamp, date_posted, bookmark_row, branch) VALUES ('$name', '$loan_type', 'loan repayment', '$parent2', '$real_interest', '$telephone', '$date' , '$date_format', '$month', '$year', '$regnum', '$staff_name', '$time_stamp1', '$date_posted', '$bookmark_row', '$branch')";
                    $result = mysqli_query($connect, $sql_statement);
    ...
    if ($names == "") {
        echo "<script type='text/javascript'> $(document).ready(function(){ 
                swal({
                         ...
                         text: 'Codename not detected!!!, cannot link to personal ledger.',
                         icon: 'warning',
                        buttons: {
                            confirm : {text:'Ok',className:'sweet-orange'},
        ...
        echo "<script> location.href = 'staff_monthly_loan_statement.php?codename=$get_code&name=$names'; </script>";
    }
            ...
            <div class="pcoded-main-container">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <!--====================SEARCHING STUDENT-->
                                                        <form action="staff_monthly_payment.php" method="POST"
                                                            ...
                                                            <?php
                                                            //          session_start();
                                                            $get_branch = $codename = $disburseloan = $dailypayment = $true = $available_blance = $check_codename = $tot_pay = "";
                ...
                swal({
                        ...
                        closeOnClickOutside: false
                                                        ...
                                                        <form action="staff_monthly_payment.php" method="POST"
                                                            enctype="multipart/form-data">
                                                            <input class="form-control" type="hidden" name="telephone"
                                                                id="codename" value="<?php echo $codename; ?>"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Loan Collected" value="<?php if ($disburseloan_with_int > 0) {
                                                                                    echo number_format($disburseloan_with_int);
                                                                                } else {
                                                                                    echo 0;
                                                                                }
                                                                                ; ?>" maxlength="12" readonly=""
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="repay_plan"
                                                                        class="form-control"
                                                                        placeholder="Monthly Repayment" value="<?php if ($monthly_payment > 0) {
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:40px; border-radius: 10px;"
                                                                        class="btn btn-dark"
                                                                        href="staff_monthly_payment.php">Reset</a>
                                                                </div>
