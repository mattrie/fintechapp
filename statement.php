 ...
 <link rel="stylesheet" href="maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
  ...
  <button id="back" onclick="goBack()" style="padding: 4px; margin-bottom:  25px;  border-radius: 8px; font-size: 16px; background-color: black; color: whitesmoke; border: 2px solid white; cursor: pointer;"><<|Back|</button>
       ...
       @$name = $_GET['name'];
        ...
        $sql_state = "SELECT * FROM contribution WHERE name = '$name'";
            $result = mysqli_query($connect, $sql_state);
             echo ' <div class="card">';
         echo '<div class="card-block table-border-style">';
     
     echo     '<div class="table-responsive" >';  
                 echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">'.$name.' - ALL SAVINGS & WITHDRAWAL</h3></CAPTION>';
    ...
    echo '<tbody class="" style="font-family: sans-serif; color:black ; font-weight:bold;">';
     while ($row=mysqli_fetch_array($result)){
        ...
        echo '<td></td>';
        echo '<td></td>';
            echo "<td style='color: green; font-size: 20px;'>" . $row['savings']."</td>"; 
            echo "<td style='color: red; font-size: 20px;'>" . $row['loan']."</td>";
            echo "<td style='color: black; font-size: 20px;'>" . $row['balance']."</td>";  
            echo "</tr>";
           }
