...
//             header("location: staff_weekly_debtors.php");
          }    
...
<html>
    <head>
        <title>WEEKLY DEBTOR DATABASE</title> <!-- HTML5 Shim and Respond.js IE10 support of HTML5 elements and media queries -->
...
<!--            <div class="row"  >
                ...
                <div class="col-sm-3">
            <form name="monthyear" action="debtors.php" method="POST" enctype="multipart/form-data">
         ...
         <select name="months" id="month" required="">
            ...
            <form name="year" action="debtors.php" method="POST" enctype="multipart/form-data">
        ...
        <br>
              <center>
                ...
                <form action="staff_weekly_debtors.php" method="POST" enctype="multipart/form-data" >
        
            <input type="text"  id="codename"  name="telephone" placeholder="Search Debtor Codename" required=""  >
...
<!--                  <form action="staff_weekly_debtors.php" method="POST" enctype="multipart/form-data" style="width: 600px;">
          ...
          <script>
             if (window.XMLHttpRequest)
                  ...
                  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
                   ...
                   xmlhttp.open("GET","staff_weekly_debtor_magic.php",true);
                                 xmlhttp.send();                
    ...
    $(select_time).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getmonth==="" || getyear===""){ 
            swal({
                   ...
                   xmlhttp.open("GET","staff_weekly_debtor_month.php?month="+getmonth+"&year="+getyear+"&evaluation="+evaluation+"&carry_group="+carry_group,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
...
//            alert('WORKING');
      ...
      document.getElementById('carry_group').value = document.getElementById('group_name').value;
        ...
        if (group_name===""){ 
            swal({
                   ...
                   xmlhttp.open("GET","staff_group_name_display_weekly.php?group="+group_name,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
       ...
       var evaluation1 = document.getElementById('evaluation1').value;
        ...
        if (getyear===""){ 
             swal({
                   ...
                   xmlhttp.open("GET","staff_weekly_debtor_year.php?year="+getyear+"&evaluation1="+evaluation1+"&carry_group="+carry_group,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
    ...
    $(show_all).click(function(e){ //Function LINK TO GO AND VIEW ALL DEBTORS button click
        e.preventDefault();
              window.location = "staff_weekly_debtors.php";
            });
        });
          </script>   
