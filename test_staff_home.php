...
//      }
       ...
       ////////////THIS IS TO SUM DAILY
           ...
           ////////////THIS IS TO SUM monthly_
                ...
                $sql12 = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM monthly_allloan");
           while  ($row3 = mysqli_fetch_array($sql12)){
              $summation_loan_monthly = $row3['total'];                         
              }
        $summation_loan_monthly = $summation_loan_monthly - $summation_repay33;
        ...
        $total_disburseloan  = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date='$date' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse'");      
...
//                        $total_disburseloan_work = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date='$date'");      
           ...
           $summation_disburseloan;  
             ...
             ////////////THIS IS TO SUM WEEKLY DISBURSE
                        ...
                        $total_disburseloan22 = mysqli_query($connect, "SELECT SUM(disburseloan) as total, SUM(interest) as totalx FROM weekly_allloan WHERE date='$date' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse'");      
...
//                       $summation_disburseloan_weekly = $summation_disburseloan_weekly - $summation_interest_weekly;  
                 ...
                 ////////////THIS IS TO SUM MONTHLY DISBURSE
                        ...
                        $total_disburseloan222 = mysqli_query($connect, "SELECT SUM(disburseloan) as total, SUM(interest) as totalx FROM monthly_allloan WHERE date='$date' AND NOT remarks = 'Penalty' AND NOT reversepen = 'penalty reverse'");      
...
//                       $summation_disburseloan_monthly = $summation_disburseloan_monthly - $summation_interest_monthly;  
        ...
        $total_disburseloan_pen  = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date='$date' AND (remarks = 'Penalty' OR reversepen = 'penalty reverse')");      
...
//                        $total_disburseloan_work = mysqli_query($connect, "SELECT SUM(disburseloan) as total FROM allloan WHERE date='$date'");      
           ...
           $summation_disburseloan_pen;  
             ...
             ////////////THIS IS TO SUM WEEKLY DISBURSE
                        ...
                        $total_disburseloan22_pen = mysqli_query($connect, "SELECT SUM(disburseloan) as total, SUM(interest) as totalx FROM weekly_allloan WHERE date='$date' AND (remarks = 'Penalty' OR reversepen = 'penalty reverse')");      
...
//                       $summation_disburseloan_weekly = $summation_disburseloan_weekly - $summation_interest_weekly;  
                 ...
                 ////////////THIS IS TO SUM MONTHLY DISBURSE
                        ...
                        $total_disburseloan222_pen = mysqli_query($connect, "SELECT SUM(disburseloan) as total, SUM(interest) as totalx FROM monthly_allloan WHERE date='$date' AND (remarks = 'Penalty' OR reversepen = 'penalty reverse')");      
                    ...
                    <!-----------------MEMBERS ARENA----------------------->   
                                                            ...
                                                            <div class="col-sm-6 p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <i class="far fa-user text-c-purple fill f-24"></i>
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                        <h5><?php echo number_format($count_members);?></h5>
                                                                        <a href="all_customers.php"><p class="text-muted m-b-0">Registered Customers</p></a>
                                                        ...
                                                        <div class="row align-items-center b-b-default">
                                                            ...
                                                            <div class="col-sm-6 p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    ...
                                                                    <div class="col-8 p-l-0">
                                                                  <h5><?php echo number_format($count_no_debt);?></h5>
                                                                        <p class="text-muted m-b-0">Non-Active Customers</p>
                                                            ...
                                                            <div class="col-sm-6 p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                   <div class="col-4 p-r-0">
                                                                    ...
                                                                    <div class="col-8 p-l-0">
                                                                    <h5><?php echo number_format($count_all_debt);?></h5>
                                       ...
                                       <!--TOTAL LOAN PORTFOLIO-->                                                             
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-red order-visitor-card">
                                                            <div class="card-block">
                                                                ...
                                                                <h6 class="m-b-0"> <a href="debtors.php" class="show_black">Daily Loan Portfolio </a></h6>
                                                                <?php if($summation_loan == ""){$summation_loan = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_loan);?></h4>
                                                                 <?php if($total_loan == ""){$total_loan = "0";}
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-red order-visitor-card">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="weekly_debtors.php" class="show_black">Weekly Loan Portfolio</a></h6>
                                                                <?php if($summation_loan_weekly == ""){$summation_loan_weekly = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_loan_weekly);?></h4>
                                                                  <?php if($total_loan == ""){$total_loan = "0";}
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-red order-visitor-card" >
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="monthly_debtors.php" class="show_black">Monthly Loan Portfolio</a></h6>
                                                                <?php if($summation_loan_monthly == ""){$summation_loan_monthly = "0";}?>
                                                                <h4 class="m-t-15 m-b-15 "><b>₦ </b><?php echo number_format($summation_loan_monthly);?></h4>
                                                                  <?php if($total_loan == ""){$total_loan = "0";}
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-red order-visitor-card">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0" style="font-size: 16px;" class="show_black">Total Loan Portfolio</h6>
                                                                <?php if($total_loan == ""){$total_loan = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($total_loan);?></h4>
                                         ...
                                         <!--THIS IS FOR TODAY'S DAILY PAYMENT-->                                                         
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-green repay">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_repayment.php?daily_see='1'" class="show_black">Today's Daily Repayment</a></h6>
                                                                ...
                                                                <p class="m-b-0" style="font-size: 16px;"><?php echo round($daily_pay_perc, 1);?>% of TTR</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                         <div class="card text-center text-c-green repay">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_repayment.php?weekly_see='1'" class="show_black">Today's Weekly Repayment</a></h6>
                                                                ...
                                                                <p class="m-b-0" style="font-size: 16px;"><?php echo round($weekly_pay_perc, 1);?>% of TTR</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                         <div class="card text-center text-c-green repay">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_repayment.php?monthly_see='1'" class="show_black">Today's Monthly Repayment</a></h6>
                                                                ...
                                                                <p class="m-b-0" style="font-size: 16px;"><?php echo round($monthly_pay_perc, 1);?>% of TTR</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-green repay">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0" style="font-size: 16px;"><a href="today_repayment.php" class="show_black">Today Total Repayment</a></h6>
                                                                <?php if($total_repayall == ""){$total_repayall = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($total_repayall);?></h4>
                                                                
                                                                <p class="m-b-0" style="font-size: 16px;">100% of TTR</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <!--THIS IS FOR TODAY'S DAILY DISBURSE-->                                                         
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_disbursment.php" class="show_black">Today's Daily Disbursement</a></h6>
                                                                <?php if($summation_disburseloan == "" || $summation_disburseloan < 1){$summation_disburseloan = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_disburseloan);?></h4>
                                                                 <?php if($total_disburseloan_all == ""){$total_disburseloan_all = "0";}
                                                                  @$daily_loan_perc = ($summation_disburseloan / $total_disburseloan_all) * 100;
                                                                 ?>
                                                                 <?php if(is_nan($daily_loan_perc)){$daily_loan_perc = 0;}?>
                                                                <p class="m-b-0" style="font-size: 16px;"><?php echo round($daily_loan_perc, 1);?>% of TTD</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                         <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_disbursment.php" class="show_black">Today's Weekly Disbursement</a></h6>
                                                                <?php if($summation_disburseloan_weekly == "" || $summation_disburseloan_weekly < 1){$summation_disburseloan_weekly = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_disburseloan_weekly);?></h4>
                                                                 <?php if($total_disburseloan_all == ""){$total_disburseloan_all = "0";}
                                                                  @$weekly_loan_perc = ($summation_disburseloan_weekly / $total_disburseloan_all) * 100;
                                                                 ?>
                                                                 <?php if(is_nan($weekly_loan_perc)){$weekly_loan_perc = 0;}?>
                                                                <p class="m-b-0" style="font-size: 16px;"><?php echo round($weekly_loan_perc, 1);?>% of TTD</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                         <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_disbursment.php" class="show_black">Today Monthly Disbursement</a></h6>
                                                                <?php if($summation_disburseloan_monthly == "" || $summation_disburseloan_monthly < 1){$summation_disburseloan_monthly = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_disburseloan_monthly);?></h4>
                                                                 <?php if($total_disburseloan_all == ""){$total_disburseloan_all = "0";}
                                                                  @$monthly_loan_perc = ($summation_disburseloan_monthly / $total_disburseloan_all) * 100;
                                                                 ?>
                                                                 <?php if(is_nan($monthly_loan_perc)){$monthly_loan_perc = 0;}?>
                                                                <p class="m-b-0" style="font-size: 16px;"><?php echo round($monthly_loan_perc, 1);?>% of TTD</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0" style="font-size: 16px;"><a href="today_disbursment.php" class="show_black">Today Total Disbursement</a></h6>
                                                                <?php if($total_disburseloan_all == "" || $total_disburseloan_all < 1){$total_disburseloan_all = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($total_disburseloan_all);?></h4>
                                                                
                                                                <p class="m-b-0" style="font-size: 16px;">100% of TTD</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                      ...
                                                      <!--------------------------TODAY'S PENALTY------------------------------------>
                                                        ...
                                                        <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_penalty.php" class="show_black">Today's Daily Penalty</a></h6>
                                                               <?php if($summation_disburseloan_pen == "" || $summation_disburseloan_pen < 1){$summation_disburseloan_pen = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_disburseloan_pen);?></h4>
                                                     ...
                                                     <!--THIS IS FOR TODAY'S WEEKLY PENALTY-->
                                                      <div class="col-md-3">
                                                        <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_penalty.php" class="show_black"> Today's Weekly Penalty</a></h6>
                                                             <?php if($summation_disburseloan_weekly_pen == "" || $summation_disburseloan_weekly_pen < 1){$summation_disburseloan_weekly_pen = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_disburseloan_weekly_pen);?></h4>
                                                      ...
                                                      <div class="col-md-3">
                                                        <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_penalty.php" class="show_black"> Today's Monthly Penalty</a></h6>
                                                              <?php if($summation_disburseloan_monthly_pen == "" || $summation_disburseloan_monthly_pen < 1){$summation_disburseloan_monthly_pen = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($summation_disburseloan_monthly_pen);?></h4>
                                                     ...
                                                     <div class="col-md-3">
                                                        <div class="card text-center text-c-red disburseloan">
                                                            <div class="card-block">
                                                                <h6 class="m-b-0"><a href="today_penalty.php" class="show_black">Today's Total Penalty</a></h6>
                                                                <?php if($total_disburseloan_all_pen == "" || $total_disburseloan_all_pen < 1){$total_disburseloan_all_pen = "0";}?>
                                                                <h4 class="m-t-15 m-b-15"><b class="">₦ </b><?php echo number_format($total_disburseloan_all_pen);?></h4>
                                               ...
                                               <div class="col-md-6">
                                                        <div class="card total-card">
                                                            <div class="card-block">
                                                                <div class="text-left bg-c-lite-green" style="border-radius: 6px; background-color: #ccffcc;">
                                                         <!--=====================List Group FOR SAVINGS=====================-->
                                                         <h4 style="color: #003300;"><span style="font-weight: bolder;"><?php echo date('F Y').": ";?>Interest Paid on Investment</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                         <a href="investor_intpay_month.php" style="font-size: 22px;"> Interest Paid <?php echo date('F Y').": ";?> </a>    <?php if($intrest_paid == ""){$intrest_paid = "0";}?>                                    
                                                 <span class="badge badge-warning badge-pill"><b class="">₦ </b><?php echo " ".number_format($intrest_paid);?></span>
                                               </li></ul>   
                                                    </h4>
                                                      ...
                                                      <div class="col-md-6 ">
                                                        <div class="card  total-card">
                                                            <div class="card-block">
                                                                <div class="text-left" style="border-radius: 6px; background-color: #ccffcc;">
                                                        <!--=====================List Group FOR INVESTMENT=====================-->
                                                        <h4 style="color: #003300;"><span style="font-weight: bolder;"><?php echo date('Y').": ";?>Interest Paid on Investment</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                         <a href="investor_intpay_year.php" style="font-size: 22px;">Interest Paid <?php echo date('Y').": ";?></a>                                       <?php if($intrest_paid_year == ""){$intrest_paid_year = "0";}?>
                                                 <span class="badge badge-warning badge-pill"><b class="">₦ </b><?php echo " ".number_format($intrest_paid_year);?></span>
                                               </li></ul>   
                                                    </h4>
                                                       ...
                                                       <div class="col-md-6 ">
                                                        <div class="card  total-card">
                                                            <div class="card-block">
                                                                <div class="text-left" style="border-radius: 6px; background-color: #ccffcc;">
                                                        <!--=====================List Group FOR INVESTMENT=====================-->
                                                        <h4 style="color: #003300;"><span style="font-weight: bolder;">Insurance Balance</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                         <a href="insurance.php" style="font-size: 22px;">Insurance Balance</a>                                       <?php if($final_total_insurance == ""){$final_total_insurance  = "0";}?>
                                                 <span class="badge badge-success badge-pill"><b class="">₦ </b><?php echo " ".number_format($final_total_insurance );?></span>
                                               </li></ul>   
                                                    </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card total-card">
                                                            <div class="card-block">
                                                                <div class="text-left bg-c-lite-green" style="border-radius: 6px; background-color: #ccffcc;">
                                                         <!--=====================List Group FOR SAVINGS=====================-->
                                                         <h4 style="color: #003300;"><span style="font-weight: bolder;">Contribution Balance</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                 <a href="contribution_ledger.php" style="font-size: 22px;">Contribution Balance</a>                                      <?php if($summation_bal == ""){$summation_bal  = "0";}?>
                                                 <span class="badge badge-warning badge-pill"><b class="">₦ </b><?php echo " ".number_format($summation_bal );?></span>
                                               </li></ul>   
                                                    </h4>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="card  total-card">
                                                            <div class="card-block">
                                                                <div class="text-left" style="border-radius: 6px; background-color: #ccffcc;">
                                                        <!--=====================List Group FOR INVESTMENT=====================-->
                                                        <h4 style="color: #003300;"><span style="font-weight: bolder;">Investors Balance</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                         <a href="investors.php" style="font-size: 22px;">Investment</a>                                      <?php if($summation_investment == ""){$summation_investment = "0";}?>
                                                 <span class="badge badge-dark badge-pill"><b class="">₦ </b><?php echo " ".number_format($summation_investment);?></span>
                                               </li></ul>   
                                                    </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card total-card">
                                                            <div class="card-block">
                                                                <div class="text-left bg-c-lite-green" style="border-radius: 6px; background-color: #ccffcc;">
                                                         <!--=====================List Group FOR SAVINGS=====================-->
                                                         <h4 style="color: #003300;"><span style="font-weight: bolder;">Savings Balance</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                         <a href="savings.php" style="font-size: 22px;">Savings</a>                                      <?php if($summation_savings == ""){$summation_savings = "0";}?>
                                                 <span class="badge badge-dark badge-pill"><b class="">₦ </b><?php echo " ".number_format($summation_savings);?></span>
                                               </li></ul>   
                                                    </h4>
                                                   ...
                                                   <div class="col-md-6 ">
                                                        <div class="card  total-card">
                                                            <div class="card-block">
                                                                <div class="text-left" style="border-radius: 6px; background-color: #99ff99;">
                                                         <!--=====================List Group FOR Weekly EQUITY=====================-->
                                                         <h4 style="color: #003300;"><span style="font-weight: bolder;">Weekly Equity Balance</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                         <a href="equity.php" style="font-size: 22px;"> Weekly Equity</a>                                      <?php if($summation_equity == ""){$summation_equity = "0";}?>
                                                 <span class="badge badge-dark badge-pill"><b class="">₦ </b><?php echo " ".number_format($summation_equity);?></span>
                                               </li></ul>   
                                                    </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card total-card">
                                                            <div class="card-block">
                                                                <div class="text-left" style="border-radius: 6px; background-color: #99ff99;">
                                                         <!--=====================List Group FOR SAVINGS=====================-->
                                                         <h4 style="color: #003300;"><span style="font-weight: bolder;">Monthly Equity Balance</span>
                                                 <ul class="list-group"><li style="" class="list-group-item d-flex justify-content-between align-items-center">
                                                         <a href="monthly_equity.php" style="font-size: 22px;">Monthly Equity</a>                                       <?php if($summation_equity_month == ""){$summation_equity_month = "0";}?>
                                                 <span class="badge badge-dark badge-pill"><b class="">₦ </b><?php echo " ".number_format($summation_equity_month);?></span>
                                               </li></ul>   
                                                    </h4>
                                                       ...
                                                       <div class="col-md-6">
                                                        <div class="card total-card">
                                                            <div class="card-block">
                                                                <div class="text-left" style="border-radius: 6px; background-color: #33ff33;">
                                                         <!--=====================List Group FOR MONTH=====================-->
                                                         <h4 style="color: #003300;"><b><span style="font-weight: bolder;"><?php echo date('F Y').": ";?> Revenue/Expenses</span></b>
                                                 <ul class="list-group"> <li  class="list-group-item d-flex justify-content-between align-items-center">
      Gross                                         <?php if($revenue == ""){$revenue = "0";}?>
      <span class="badge badge-success badge-pill">N<?php echo " ".number_format($revenue);?></span>
    </li>
    <li  class="list-group-item d-flex justify-content-between align-items-center">
      Expenses                                         <?php if($expenses == ""){$expenses = "0";}?>
      <span class="badge badge-danger badge-pill">N<?php echo " ".number_format($expenses);?></span>
    </li>
    <li  class="list-group-item d-flex justify-content-between align-items-center">
      Net                                         <?php if($profit == ""){$profit = "0";}?>
      <span class="badge badge-primary badge-pill">N<?php echo " ".number_format($profit);?></span>
    </li></ul>   
                                                    </h4>
                    ...
                    <div class="col-md-6">
                                                        <div class="card total-card">
                                                            <div class="card-block">
                                                                <div class="text-left bg-c-yellow" style="border-radius: 6px; background-color: #33ff33;">
                                                        <!--=====================List Group FOR YEAR=====================-->
                                                        <h4 style="color: #003300;"><span style="font-weight: bolder;"><?php echo date('Y').": ";?> Revenue/Expenses</span>
                                                 <ul class="list-group"> 
    <li  class="list-group-item d-flex justify-content-between align-items-center">
      Gross                                         <?php if($revenue_year == ""){$revenue_year = "0";}?>
      <span class="badge badge-success badge-pill">N<?php echo " ".number_format($revenue_year);?></span>
    </li>
    <li  class="list-group-item d-flex justify-content-between align-items-center">
      Expenses                                         <?php if($expenses_year == ""){$expenses_year = "0";}?>
      <span class="badge badge-danger badge-pill">N<?php echo " ".number_format($expenses_year);?></span>
    </li>
    <li  class="list-group-item d-flex justify-content-between align-items-center">
      Net                                         <?php if($profit_year == ""){$profit_year = "0";}?>
      <span class="badge badge-primary badge-pill">N<?php echo " ".number_format($profit_year);?></span>
    </li></ul>   
                                                    </h4>
                   ...
                   <center style="font-size: 18px; color: black; margin-top: 5px;"><footer class="">&copy;<?php echo date('Y')?>. By Matt.</footer></center>                     
