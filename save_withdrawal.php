...
//                                $telephone = $_POST['telephone'];
          ...
          while($row_check = mysqli_fetch_assoc($check)){
                   $get_check = $row_check['ref'];
                           ...
                           if($get_check == $ref){           
            //INSERT RECORD2
      $sql_statement = "INSERT INTO contribution (name, amount, withdraw, date, ref, month, year, district, collector) Values('$name', '-','$parent',  '$date', '$ref', '$month', '$year' , '$regnum', 'admin')";
                     $result2 = mysqli_query($connect, $sql_statement); 
                  } else {
      $sql_statement2 = "INSERT INTO contribution (name, amount, withdraw, date, month, year, district, collector) Values('$name', '-','$parent',  '$date', $month', '$year' , '$regnum', 'admin')";
                ...
                include 'admin_nav2.php';
                  ...
                  <div class="pcoded-inner-content">
                     ...
                     <div class="row">
                              ...
                              <!--====================SEARCHING STUDENT-->
           <form action="save_withdrawal.php" method="POST" enctype="multipart/form-data" >
              <center>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                   <input style="margin-left:100px; padding: 8px; width: 25%; font-weight: bold; background-color:  red; border-radius: 10px;" class="btn" id="update"  type="submit" name="withd"  value="Withdraw" /> 
                                                                         <a style="margin-left:40px; border-radius: 10px;" class="btn btn-dark" href="save_withdrawal.php">Reset</a>
                                                                </div>
