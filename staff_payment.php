...
//                     $date_test =  date('Y-m-d', strtotime($date));
        ...
        if ($days_remaining > 1 || $r_tomorrow > 0) {
            ...
            if ($parent2 > $bal_with_interest) {
                ...
                if ($pay_pen == "P") {
                    ...
                    $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date, date_format, month, year, collector, branch) VALUES('$name daily Penalty', 'penalty_daily', 'daily', '$parent2', '$date', '$date_format', '$month','$year', '$staff_name', '$branch')");
                    $parent = $parent2;
                    ...
                    $sql_statement = "INSERT INTO allloan (name, type, remarks, repay, interest_pay, codename, date, date_format, month, year, district, collector, timestamp, dob, updatemark, bookmark_row, branch) VALUES ('$name', '$loan_type', 'Penalty Paid', '$parent', '0','$telephone', '$date', '$date_format', '$month', '$year', '$regnum', '$staff_name', '$time_stamp1', '$group_name', '$staff_name', '$bookmark_row', '$branch')";
                    ...
                    $result38 = mysqli_query($connect, "UPDATE allloan SET updatemark = '' WHERE updatemark = '$staff_name'");
                ...
                swal({
                    ...
                    $staff_name = $_SESSION['staff_full_name'];
                    $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date,date_format, month, year, collector, branch) VALUES('$name daily interest', 'interest_daily', 'daily', '$interest_to_revenue', '$date','$date_format','$month','$year', '$staff_name', '$branch')");
                    ...
                    $bookmark_row = rand(10, 1000000000000);
                    $sql_statement = "INSERT INTO allloan (name, type, remarks, repay, interest_pay, codename, date , date_format, month, year, district, collector, timestamp, dob, updatemark, date_posted, bookmark_row, branch) VALUES ('$name', '$loan_type', 'loan repayment', '$parent', '$interest_to_revenue','$telephone', '$date' , '$date_format', '$month', '$year', '$regnum', '$staff_name', '$time_stamp1', '$group_name', '$staff_name', '$date_posted', '$bookmark_row', '$branch')";
                    $result = mysqli_query($connect, $sql_statement);
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <!--====================SEARCHING STUDENT-->
                                                        <form action="staff_payment.php " method="POST"
                        ...
                        closeOnClickOutside: false
                                                        ...
                                                        <form action="staff_payment.php" method="POST"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    <input type="hidden" name="shadow" id="nam"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Loan Collected" value="<?php if ($amt_disburseloan > 0) {
                                                                                    echo number_format($amt_disburseloan);
                                                                                } else {
                                                                                    echo 0;
                                                                                }
                                                                                ; ?>" maxlength="12" readonly=""
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="loan_type"
                                                                                ...
                                                                                <option value="Daily Payment">Daily
                                                                                    Payment</option>
                            ...
                            <option value="P">P</option>
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        required="" name="parent" maxlength="20"
                                                                        autofocus="">
                                                                    <select name="pay_pen">
                                                                    ...
                                                                    <input type="hidden" style="margin-left: 50px;"
                                                                        name="bad_debt" value="ON" />
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Daily
                                                                    Repayment:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="repay_plan"
                                                                        class="form-control"
                                                                        placeholder="Repayment Plan" value="<?php if ($dailypayment > 0) {
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        ...
                                                                        value="<?php echo $codename; ?>" maxlength="10"
                                                                        required="">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:40px; border-radius: 10px;"
                                                                        class="btn btn-dark"
                                                                        href="staff_payment.php">Reset</a>
                                                                </div>
...
<![endif]-->
        ...
        <script>
            ...
            //                   xmlhttp.open("GET","loan_test_statement.php?name="+nam+"&codename="+codename,true);
            //                                 xmlhttp.send();
