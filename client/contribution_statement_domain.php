...
<body style="margin-top: 90px; background-color: #e0d3d3; ">
    <center class="heading"><div class="trans fixed-top" style="background-color:#ff5d0f; font-size: 22px; color: black;"><b>FINSOLUTE</b></div></center>
           ...
           <div class="row" style="margin-left: 200px;">
               <div class="col-sm-4" >
                   ...
                   <form  action="contribution_statement_domain.php" method="POST" enctype="multipart/form-data">
          ...
          <form action="contribution_statement_domain.php" method="POST" enctype="multipart/form-data">
              ...
              <a style="border-radius: 8px; padding:8px; font-style:italic ; font-size: 18px; background-color:green; color: whitesmoke; cursor: pointer" class="btn" href="contribution_statement_domain.php">VIEW ALL</a> <br>
