...
//          header("location:loan_statement_domain.php?codename=". $get_code."&name=".$names1.""); 
         echo  "<script> location.href = 'loan_statement_domain.php?codename=$get_code&name=$names1'; </script>";     
          ...
          $names2 = ""; 
            ...
            $result2 = mysqli_query($connect, $sql_state2);
                   ...
                   if($names2 != ""){
//                      header("location:weekly_loan_statement_domain.php?codename=".$get_code2."&name=".$names2."");  
                echo  "<script> location.href = 'weekly_loan_statement_domain.php?codename=$get_code2&name=$names2'; </script>";     
...
//          header("location:monthly_loan_statement_domain.php?codename=".$get_code3."&name=".$names3."");   
            echo  "<script> location.href = 'monthly_loan_statement_domain.php?codename=$get_code3&name=$names3'; </script>";     
...
//          header("location:investors_statement_domain.php?codename=".$get_code4."&name=".$names4."");   
          echo  "<script> location.href = 'investors_statement_domain.php?codename=$get_code4&name=$names4'; </script>";     
...
//          header("location:contribution_statement_domain.php?name=".$names5."");  
          echo  "<script> location.href = 'contribution_statement_domain.php?name=$names5'; </script>";     
...
<html>
 ...
 <link rel="stylesheet" href="maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
  ...
  <script src="maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <center class="heading"><div class="trans fixed-top" style="background-color:#ff5d0f; font-size: 22px; color: black;"><b><a href="https://finsoluteinvestment.ng" style="color: black;">FINSOLUTE</a></b></div></center>
     ...
     <hr style="color: red; height: 3px; margin-top: 0.5px"/>
        ...
        <div class="container-fluid ">
            ...
            <center>
                  ...
                  <form action="index.php" method="POST" enctype="multipart/form-data" style="margin-top: 200px;">
    ...
    $(select_time).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getmonth==="" || getyear===""){ 
                alert("You must fill month and year to search");
                   ...
                   xmlhttp.open("GET","debtor_month.php?month="+getmonth+"&year="+getyear+"&evaluation="+evaluation,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
    ...
    $(select_year).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getyear===""){ 
                alert("You must fill year to search");
                   ...
                   xmlhttp.open("GET","debtor_year.php?year="+getyear+"&evaluation1="+evaluation1,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
...
//            alert('WORKING');
        ...
        if (group_pass===""){ 
                alert("You must search for group first");
                   ...
                   xmlhttp.open("GET","group_domain_display.php?group="+group_pass,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    function extractLast( term ) {
     ...
     <footer style="bottom: 0; left: 0; right: 0; position: fixed; background-color: #ff5d0f; color: black; font-size: 22px; font-weight: bold;">
         <marquee>Please enter your correct code name to view transaction details. FINSOLUTE *SAVINGS & LOAN* <label style="font-style: italic;">always there for you!!!</label> &copy;<?php echo date("Y")?>. By EasyMaster.</marquee>
