...
//             header("location: weekly_codename_search.php");
          }  
...
<body>
    ...
    <form action="codename_search.php" method="POST" enctype="multipart/form-data" style="margin-bottom: 20px; margin-top: 30px;" >
...
//            alert('WORKING');
        ...
        if (autocomplete===""){ 
                alert("You must search for name first");
                   ...
                   xmlhttp.open("GET","codename_search_display.php?codename="+autocomplete,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
    ...
    $(show_all).click(function(e){ //Function LINK TO GO AND VIEW ALL DEBTORS button click
        e.preventDefault();
              window.location = "codename_search.php";
            });
        });
          </script>   
