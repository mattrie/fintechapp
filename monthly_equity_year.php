...
//           balance > 1 is to avoid repetition
     $result = mysqli_query($connect, "SELECT * FROM monthly_allloan WHERE year = '$year' AND (equity > '1' OR withdrawequity > '1') ORDER BY id DESC");  
    
   echo ' <div class="card card-block table-border-style">';       
     echo     '<div class="table-responsive">

     <CAPTION><h3 style="font-size:22px; color:black; font-weight:bold;" align="center">'.$year.' MONTHLY_EQUITY</h3></CAPTION>
