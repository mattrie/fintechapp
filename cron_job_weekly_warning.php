                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Weekly Warning</h5>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        while ($row = mysqli_fetch_assoc($quco111)) {
                                            ...
                                            $get_warning = mysqli_query($connect, "SELECT * FROM weekly_allloan");
                                            while ($row = mysqli_fetch_assoc($get_warning)) {
                                                $warning = $row['warning'];
                                            }
                                            if ($days_remaining > 20 && $days_remaining < 29 && $get_weeklyindbal > 1 && $warning == "") {
                                                ...
                                                $update_warning = mysqli_query($connect, "UPDATE weekly_allloan SET warning='warning' WHERE indbalance > 1 AND remarks = 'loan disbursement' AND codename = '$weeklycode'");

                                                //..........................TERMII SMS START.......................................
                                        
                                                //                                                    $sms_name = $name;
                                        
                                                $due_date = date("jS F Y", strtotime($get_weeklyenddate));
                                                $sms_balance = number_format($get_weeklyindbal);
                                                $naija_code = "+234";
