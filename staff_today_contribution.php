...
<!--       <form action="staff_today_contribution.php" method="POST" enctype="multipart/form-data">
...
<!--     <form action="staff_today_contribution.php" method="POST" enctype="multipart/form-data" >
         ...
         <select name="type"  required="">
               ...
               &nbsp; &nbsp;       
                    ...
                    <a style="" class="btn btn-dark" href="staff_today_contribution.php">View All</a> <br>
               </div>
...
//            ///////////////////////////BACK DATE ARENA//////////////////////////
                ...
                $backd = $_POST['backd'];
     echo         @$staff_name = $_SESSION['staff_full_name'];
     ...
     while ($row=mysqli_fetch_array($result)){
           ...
           $inc++;
                ...
                ////////////THIS IS TO SUM amount
                        $total_amount = mysqli_query($connect, "SELECT SUM(amount) as totalx FROM contribution WHERE date='$output_date' AND collector = '$staff_name'");      
                          while  ($row = mysqli_fetch_array($total_amount)){
                          $summation_amount = $row['totalx'];                          
                          }
