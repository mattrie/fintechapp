...
if (isset($_POST['loan'])) {
    ...
    if ($name != "") {
// By  Adedokun Adewale Azeez 25th November 2020
        ...
        $ind_invest_balance = $_SESSION['available_blance'];
        if ($parent > $ind_invest_balance) {
            echo "<script type='text/javascript'> $(document).ready(function(){ 
                swal({
                         title: 'Balance Check!',
                         text: 'Insufficient Investment balance. Cannot withdraw " . number_format($parent) . " Naira. Available Investment for codename $telephone is " . number_format($ind_invest_balance) . " Naira.',
                         icon: 'warning',
                        buttons: {
            ...
            $sql_statement25 = "INSERT INTO investment (name, codename, remarks, withdraw, date, month, year, district, time) VALUES ('$name', '$telephone', 'Investment Withdraw', '$parent', '$date', '$month', '$year', '$regnum', '$time_stamp1')";

            $result = mysqli_query($connect, $sql_statement25);
            ...
            $update_special = mysqli_query($connect, "UPDATE investment SET sum_pay = '$summation_pay_sum', sum_withdraw = '$summation_withdraw_sum', updatebal = '$ind_balance' WHERE codename = '$telephone' AND remarks = 'Investment deposited' AND pay > 1");
...
//              "to": "'.$phone.'",
//               "from": "FINSOLUTE",
//               "sms": "Withdrawal-> ₦'.$sms_parent.' Inv_Bal->₦'.$sms_ind_balance.' Interest_Bal->₦'.$sms_balance.'",
//               "type": "plain",
//               "channel": "generic",
...
//    //echo $response;
                ...
                swal({
                         title: 'Success!',
                         text: '$name has successfully withdrawn  " . number_format($parent) . " Naira from Investment ($telephone). Available Investment for codename $telephone is: " . number_format($ind_balance) . " Naira.',
                         icon: 'success',
                        buttons: {
                            confirm : {text:'Ok',className:'sweet-orange'},
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Investor Withdraw</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Investor Withdraw</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">
                                                        <!--====================SEARCHING STUDENT-->
                                                        <form action="investor_withdraw.php" method="POST"
                                                            enctype="multipart/form-data">
                                                            <center>
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control"
                                                                        id="codename1" name="telephone"
                                                                        placeholder="Search Investor with codename to Withdraw"
                                                                        required="">
                        ...
                        closeOnClickOutside: false
                                                        ...
                                                        <form action="investor_withdraw.php" method="POST"
                                                            ...
                                                            <!--                                                                <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                              <input  type="text" name="backdate"  placeholder="IF BackDate is True" onfocus="(this.type='date')" style="width: 200px; border-radius: 5px; " >
                                                                  </div>
                                                            </div>-->


                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Investment Code
                                                                    Name:</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    <input
                                                                        style=" padding: 8px;  font-weight: bold; background-color: #ff3333;"
                                                                        class="btn button-distance" id="update"
                                                                        type="submit" name="loan" onclick="click_test()"
                                                                        value="Withdraw" />
                                                                    <a style="margin-left:40px; border-radius: 10px;"
                                                                        id="btu" class="btn btn-dark"
                                                                        href="investor_withdraw.php">Reset</a>
                                                                </div>
