...
//             header("location: weekly_staff_codename_search.php");
          }  
...
<body>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Active</h5>
                                            <p class="m-b-0">Search Active Transaction</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
    ...
    <form action="staff_codename_search.php" method="POST" enctype="multipart/form-data" style="margin-bottom: 20px; margin-top: 30px;" >
        <input type="text" class="form-control  mb-4"  id="autocomplete" name="group_name" style="" placeholder="Search Name to reveal code" required=""  >
...
//            alert('WORKING');
        ...
        if (autocomplete===""){ 
                alert("You must search for name first");
                   ...
                   xmlhttp.open("GET","staff_codename_search_display.php?codename="+autocomplete,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
    ...
    $(show_all).click(function(e){ //Function LINK TO GO AND VIEW ALL DEBTORS button click
        e.preventDefault();
              window.location = "staff_codename_search.php";
            });
        });
          </script>   
