...
//   include 'connection.php';
 if(isset($_POST['submit'])){
    // By  Adedokun Adewale Azeez 12th August 2020
                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="fin_admin.php" method="POST">
                            <div class="text-center">
                                <i style="color: #ccffcc;">_<b style="font-weight: bolder; font-size: 24px;">FINSOLUTE</b><b style="font-size: 16px;">INVESTMENT</b>_</i>
                        </div>
