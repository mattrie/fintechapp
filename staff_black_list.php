                                    ...
                                    <div class="page-wrapper">
                                        ...
                                        <div class="page-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <form name="srch" action="staff_black_list.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-4" style="text-align: right;">
                                                    <a href="staff_black_list.php" class="btn btn-success">VIEW ALL</a>
                                                </div>
...
//                                                    echo "<script>alert('$get_name I see you well $total_ckeck');</script>";        
        include 'staff_show_debt_ledger.php';
    }
}
...
if (isset($_POST['btnsrch'])) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td ><a style='color:brown;' href='staff_black_list.php?get_name=" . $row['namee'] . "'>View Debt</a></td>";
                                            ...
                                            <script>
                                                $(document).ready(function () {
                                                    ...
                                                    $(show_all).click(function (e) { //Function LINK TO GO AND VIEW ALL DEBTORS button click
                                                        e.preventDefault();
                                                        window.location = "staff_black_list.php";
                                                    });
                                                });
                                            </script>   
