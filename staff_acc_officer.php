...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">DAILY ACCOUNT OFFICER</h5>
         ...
         <form action="staff_acc_officer.php" method="POST" enctype="multipart/form-data" >
    ...
    <div class="input-group-append">
      <button class="btn btn-warning" id="btnsearch" name="btnsrch" type="submit">SEARCH</button>  
             ...
             <div class="row">                             
                 <div class="col-sm-2">
                                        <a href="staff_acc_officer.php" class="btn btn-dark">View All</a> 
                                     </div>
                 <div class="col-sm-2">
