...
//             @header("location:staff_weekly_payment.php ");
//         }
//    ob_start();
//session_start();
...
// By  Adedokun Adewale Azeez 17th November 2020
    if ($name != "") {
...
//                     $date_test =  date('Y-m-d', strtotime($date));
        ...
        if ($days_remaining > 1 || $r_tomorrow > 0) {
            ...
            if ($parent2 > $available_blance) {
                ...
                if ($pay_pen == "P") {
                    $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date, date_format, month, year, collector, branch) VALUES('$name weekly Penalty', 'penalty_weekly', 'weekly', '$parent2', '$date', '$date_format', '$month','$year', '$staff_name', '$branch')");
                    ...
                    $sql_statement = "INSERT INTO weekly_allloan (name, type, remarks, repay, codename, date, date_format, month, year, district, lastpaiddate, collector, savings, timestamp, dob, bookmark_row, branch) VALUES ('$name', '$loan_type', 'Penalty Paid', '$parent2', '$telephone', '$date', '$date_format', '$month', '$year', '$regnum', '$today_date', '$staff_name', '$savings_alone', '$time_stamp1', '$group_name', '$bookmark_row', '$branch')";
                ...
                swal({
                    ...
                    $staff_name = $_SESSION['staff_full_name'];
                    $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date, month, year, collector, branch) VALUES('$name weekly interest', 'interest_weekly', 'weekly', '$interest_to_revenue', '$date','$month','$year', '$staff_name', '$branch')");
                    ...
                    $bookmark_row = rand(10, 100000000);
                    $sql_statement = "INSERT INTO weekly_allloan (name, type, remarks, repay, codename, date, date_format, month, year, district, lastpaiddate, collector, savings, timestamp, dob, date_posted, bookmark_row, branch) VALUES ('$name', '$loan_type', 'loan repayment', '$parent2', '$telephone', '$date', '$date_format', '$month', '$year', '$regnum', '$today_date', '$staff_name', '$savings_alone', '$time_stamp1', '$group_name', '$date_posted', '$bookmark_row', '$branch')";
                    $result = mysqli_query($connect, $sql_statement);
...
if (isset($_POST['move'])) {
    ...
    if ($names == "") {
        ...
        echo "<script> location.href = 'staff_weekly_loan_statement.php?codename=$get_code&name=$names'; </script>";
    }
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <!--====================SEARCHING STUDENT-->
                                                        <!--====================SEARCHING STUDENT-->
                                                        <form action="staff_weekly_payment.php " method="POST"
                                                        ...
                                                        <form action="staff_weekly_payment.php" method="POST"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text"
                                                                        onkeypress="return CheckNumeric()"
                                                                        onkeyup="FormatCurrency(this)" value="0"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:40px; border-radius: 10px;"
                                                                        class="btn btn-dark"
                                                                        href="staff_weekly_payment.php">Reset</a>
                                                                </div>
