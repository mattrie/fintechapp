...
<body>
    ...
    <div id="pcoded" class="pcoded">
     ...
     echo     '<div class="table-responsive" >';   
                 echo '<CAPTION><h3 align="center" style="font-size:28px; color:black;">EXPIRES WITHIN 3 DAYS [MONTHLY WARNING]</h3></CAPTION>';
     ...
     while ($row = mysqli_fetch_assoc($quco111)){
        ...
        $days_remaining = floor($remaining / 86400);  
            ...
            echo "<td>" . date('jS F Y' ,strtotime($row['monthlyenddate']))."</td>";  
               echo "<td>" . $days_remaining." day(s)</td>";  
