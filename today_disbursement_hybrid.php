...
if (isset($_POST['view_al22']) && $_POST['work'] == "") {
  echo "<script> location.href = 'today_disbursement_hybrid.php'; </script>";
}
...
<head>
  <title>TODAY'S HYBRID DISBURSEMENT</title>
              ...
              <div class="main-body">
                <div class="page-wrapper">
                  ...
                  <div class="page-body">
                    ...
                    <form action="today_disbursement_hybrid.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-sm-7">
                        <form action="today_disbursement_hybrid.php" method="POST" enctype="multipart/form-data">
                          ...
                          <button type="submit" name="year_a" id="date_sorting"
                            ...
                            Type</button>
                          <!--<a style="" class="btn btn-dark" href="today_disbursement_hybrid.php">View All</a> <br>-->
