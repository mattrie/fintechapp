                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php
                                                            echo "<a class='btn' style='color: whitesmoke; background-color: green;' href='payment.php?codename=" . $codename . " &name=" . $name . "'>Make Payments</a>";
                                                            echo "<br><a href='payment.php' style='color:blue;'>Click Here for Blank Payment Panel</a>";
                                                            echo "<br><br>";
...
//              $available_blance =  $summation_loan2 - $summation_pay2;
    ...
    <div class="progress-bar progress-bar-striped ' . $bg_color . '" style="width:' . $performance . '%;"></div>
           ...
           var name = document.getElementById('name').value;
            ...
            xmlhttp.open("GET","officer_daily.php?get_value="+value+"&name="+name+"&codename="+codename,true);
            xmlhttp.send();
...
//                                 window.location = 'staff_loan.php';
      ...
      var name = document.getElementById('name').value;
            ...
            xmlhttp.open("GET","start_daily_penalty.php?get_value="+value+"&name="+name+"&codename="+codename,true);
            xmlhttp.send();
            xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
////                 document.getElementById("dispay").innerHTML = xmlhttp.responseText;;
                    ...
                    swal({
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                ...
                                xmlhttp.open("GET", "stop_daily_penalty.php?name=" + name + "&codename=" + codename, true);
                                xmlhttp.send();
                    ...
                    swal({
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                ...
                                xmlhttp.open("GET", "reverse_loan_bal.php?name=" + name + "&codename=" + codename + "&district=" + district + "&av_bal=" + av_bal, true);
                                xmlhttp.send();
                    ...
                    swal({
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                ...
                                xmlhttp.open("GET", "stop_bad_debt.php?name=" + name + "&codename=" + codename, true);
                                xmlhttp.send();
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    Repayment [Daily]:
                    <input class="form-control" type="text" value="<?php echo number_format($repayment); ?>"
                        readonly="">
                    <br>
