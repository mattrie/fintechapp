    ...
    if ($name != "") {
        ...
        if ($parent2 > $bal_with_interest) {
            ...
            if ($pay_pen == "P") {
                ...
                $sql_statement = "INSERT INTO allloan (name, type, remarks, repay, interest_pay, codename, date, date_format, month, year, district, collector, timestamp, dob, updatemark, date_posted, bookmark_row, branch) VALUES ('$name', '$loan_type', 'Penalty Paid', '$parent', '0','$telephone', '$date', '$date_format', '$month', '$year', '$regnum', 'admin', '$time_stamp1', '$group_name', 'admin1', '$date_posted', '$bookmark_row', '$branch')";
