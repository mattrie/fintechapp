...
<html>
    <head>
        <title>TODAY'S DEPOSIT</title> <meta content="width=device-width, initial-scale=1.0" name="viewport">
 ...
 <link rel="stylesheet" href="maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
  ...
  <script src="maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <body style="background-color: #e0d3d3;">
     ...
     $result = mysqli_query($connect, "SELECT * FROM contribution WHERE date = '$date' AND amount > '1' ORDER BY  name");
              echo ' <div class="card">';
         echo '<div class="card-block table-border-style">';
     
     echo     '<div class="table-responsive" >';               
     echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">MONEY CONTRIBUTED: '.$date.'</h3></CAPTION>';
     ...
     while ($row=mysqli_fetch_array($result)){
           ...
           $inc++;
                ...
                ////////////THIS IS TO SUM CONTRIBUTION
                        $total_savings = mysqli_query($connect, "SELECT SUM(amount) as total FROM contribution WHERE date='$date'");      
            ...
            echo "<td style='color: green; font-size: 20px;'>".$summation."</td>";  
            echo "<td>--------</td>";
              echo "</tr>";
