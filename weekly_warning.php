...
<body>
    ...
    <div id="pcoded" class="pcoded">
     ...
     echo     '<div class="table-responsive" >';   
                 echo '<CAPTION><h3 align="center" style="font-size:28px; color:black;">EXPIRES WITHIN 3 DAYS [WEEKLY WARNING]</h3></CAPTION>';
...
///////////////////////////////////////
        ...
        $days_remaining = floor($remaining / 86400);  
            ...
            echo "<td>" . $row['namee']."</td>";
              echo "<td>" . $row['weeklycode']."</td>"; 
            echo "<td>" . number_format($row['weeklyindbal'])."</td>"; 
            echo "<td>" . date('jS F Y' ,strtotime($row['weeklyenddate']))."</td>";  
                 echo "<td>" .$to_expire = 24 - $days_remaining ." day(s)</td>";   
             
          echo "<td ><a style='color:brown;' href='weekly_loan_statement.php?codename=" . $row['weeklycode']. "&name=".$row['namee']."'>View details</a></td>";
