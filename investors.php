                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">INVESTORS DATABASE</h5>
                                    ...
                                    <div class="page-body">
                                        <div class="row" style="">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <form name="delete_table_info" action="investors.php" method="POST"
                                                    enctype="multipart/form-data">
                                                    <button name="delete_table" id="table_delete"
                                                        style="font-weight: bold; border-radius: 8px; padding:7px; font-style:italic ; font-size: 14px; background-color:#ff3333; color: whitesmoke; cursor: pointer; margin-left: 45px;">Clear
                                                        Table</button>
                                                </form>
                                            </div>

                                            <div class="col-sm-3">
                                                <form name="monthyear" action="investors.php" method="POST"
                                                    enctype="multipart/form-data">
                                                    ...
                                                    <br>
                                                    <button name="month_year" class="select_time"
                                            ...
                                            <div class="col-sm-3" style="margin-left: 80px;">
                                                <form name="year" action="investors.php" method="POST"
                                                    enctype="multipart/form-data">
                                                    ...
                                                    <br>
                                                    <button name="year_a" class="select_year"
                                                        style="font-weight: bold; border-radius: 8px; padding:7px; font-style:italic ; font-size: 14px; background-color:green; color: whitesmoke; cursor: pointer; margin-bottom: 10px;">Search
                                                        Year</button>
                                        ...
                                        <center>
                                            ...
                                            <form action="investors.php" method="POST" enctype="multipart/form-data">

                                                <div class="input-group">
                                                    <input type="text" class="form-control w-25" id="codename"
...
//              }
                                            ...
                                            $result = mysqli_query($connect, "SELECT * FROM investment WHERE remarks = 'Investment deposited' AND updatebal > 0 ORDER BY id DESC");
  ...
  <table class="table table-bordered table-striped   table-hover table_id" >
    ...
    <tbody class="" style="font-family: sans-serif; color:black ; font-weight:bold;">';
                                            ...
                                            while ($row2 = mysqli_fetch_array($total_disburse2)) {
                                                $summation_disburseloan = $row2['total'];
                                            }
