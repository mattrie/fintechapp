...
<html>
    <head>
        <title>MONTHLY DEBTOR DATABASE</title>  <!-- HTML5 Shim and Respond.js IE10 support of HTML5 elements and media queries -->
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <div class="row" >
                ...
                <div class="col-sm-3">
            <form name="monthyear" action="staff_monthly_debtors.php" method="POST" enctype="multipart/form-data">
      <input type="hidden"  id="evaluation" class="autocomplete_staff" name="telephone" placeholder="Staff Evaluation (month)"  ><br>
        <select name="months" id="month" required="">
            ...
            <form name="year" action="staff_monthly_debtors.php" method="POST" enctype="multipart/form-data">
         ...
         <button class="show_all" style="border-radius: 8px; padding:8px; font-style:italic ; font-size: 18px; background-color:green; color: whitesmoke; cursor: pointer">VIEW ALL</button>
            ...
            <center>
             ...
             <div class="col-sm-6">   
                 ...
                 <form action="staff_monthly_debtors.php" method="POST" enctype="multipart/form-data" >
        
                     <input type="text"  id="codename"  name="telephone" placeholder="Search Debtor Codename" style="width: 50%;" required=""  >
      <button class="btn btn-warning" id="btnsearch" name="btnsrch" type="submit">SEARCH</button>  
      </form> 
   </div>  
                 
    <!--THIS IS TO SEARCH GROUP NAME-->
<!--    <form action="staff_monthly_debtors.php " method="POST" enctype="multipart/form-data" style="margin-bottom: 20px;" >
          ...
          <script>
             if (window.XMLHttpRequest)
                  ...
                  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
                   ...
                   xmlhttp.open("GET","staff_monthly_debtor_magic.php",true);
                                 xmlhttp.send();                
    ...
    xmlhttp.open("GET","staff_monthly_debtor_month.php?month="+getmonth+"&year="+getyear+"&evaluation="+evaluation,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
    ...
    $(select_year).click(function(e){ //THIS IS TO DISPLAY SELECTED CLASS
        ...
        if (getyear===""){ 
              swal({
                   ...
                   xmlhttp.open("GET","staff_monthly_debtor_year.php?year="+getyear+"&evaluation1="+evaluation1,true);
                                 xmlhttp.send();                
                                 xmlhttp.onreadystatechange = function(){                                   
                      if(xmlhttp.readyState ===4 && xmlhttp.status===200) {
                 document.getElementById("dispay_db").innerHTML = xmlhttp.responseText;;
...
//            alert('WORKING');
    ...
    $(show_all).click(function(e){ //Function LINK TO GO AND VIEW ALL DEBTORS button click
        e.preventDefault();
              window.location = "staff_monthly_debtors.php";
            });
        });
          </script>   
