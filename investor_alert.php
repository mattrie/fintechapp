...
<body>
    ...
    <div id="pcoded" class="pcoded">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Investors Alert</h5>
     ...
     echo     '<div class="table-responsive" >';   
                 echo '<CAPTION><h3 align="center" style="font-size:28px; color:black;">SET FOR MONTHLY INTEREST [INVESTORS]</h3></CAPTION>';
      echo '<table class="table table-bordered table-striped   table-hover " >';
       ...
       echo ' <thead class="thead-dark">'; 
         ...
         echo '<th>From</th>';
           echo '<th>Set Prefered Date to Charge Interest</th>';
    ...
    echo '<tbody class="" style="font-family: sans-serif; color:black ; font-weight:bold;">';
      ...
      $next_date  = date('F Y', strtotime($lastpaid. ' + 31 days')); 
          $jSdate = $get_jSday_only." ".$next_date; //Final Concatination             
            ...
            echo "<td>" . $jSdate."</td>";  
             echo '  <form name="investors_statement" action="investors_statement.php" method="GET" enctype="multipart/form-data">';   
               echo "<td><input type='date' name='date_charge' required=''></td>"; 
                   echo "<input type='hidden' name='name' value='".$row['name']."'>"; 
                   echo "<input type='hidden' name='codename' value='".$row['codename']."'>";      
         echo "<td ><button type='submit' name='inv_date'>View details</button></td>";
