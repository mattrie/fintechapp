...
//          $codename_search = $_REQUEST['codename']; 
     ...
     $result = mysqli_query($connect, "SELECT * FROM allloan WHERE  sum_unearned >= 40 AND indbalance > 0 AND remarks = 'loan disbursement'");
    ...
    echo ' <div class="card card-block table-border-style">';       
     ...
     echo '<CAPTION><h3 align="center" style="font-size:22px; color: black;">UNEARNED INCOME</h3></CAPTION>';
