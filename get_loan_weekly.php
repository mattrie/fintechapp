...
// By  Adedokun Adewale Azeez 19th November 2020
        ...
        if ($get_code_result == "") {
            ...
            if ($figure > 1) {
                ...
                $sql_statement2 = "INSERT INTO revenuexp (remaks, category, type, revenue, date, date_format, month, year, collector, branch) Values('$name processing fee for weekly loan', 'pro_fee_weekly', 'weekly', '$to_revenue', '$date', '$startdate', '$month', '$year', '$collector_name', '$branch')";
            ...
            $sql_statement = "INSERT INTO weekly_allloan (name, type, remarks, disburseloan, indbalance, interest, percentage, codename, date, date_format, month, year, district, weeks, startdate, enddate, lastpaiddate, collector, proposedsavings, equity, timestamp, dob, insurance_in, acc_officer, branch, staff_full_name) VALUES ('$name', '$loan_type', 'loan disbursement', '$real_ind_payback', '$real_ind_payback', '$figure', '$percentage', '$telephone', '$date', '$startdate','$month', '$year', '$regnum', '$no_weeks', '$startdate', '$closedate', '$lastpaid_date', 'admin', '$savings', '$equity', '$time_stamp1', '$group_name', '$insure_figure', '$acc_officer', '$branch', '$staff_full_name')";
            ...
            if ($result == true) {
                ...
                $mssg = "Disbursed->₦$sms_parent Re-pay->₦$sms_amt_disburseloan Expiry_DT->$sms_output_closedate";
                $laon = "Loan";
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">BOOK WEEKLY LOAN</h5>
                                            <p class="m-b-0">Book Down for Weekly</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>BOOK WEEKLY LOAN</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">
                                                        <!--====================SEARCHING STUDENT-->
                                                        <form action="get_loan_weekly.php" method="POST"
                                                        ...
                                                        <form action="get_loan_weekly.php" method="POST"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Select
                                                                    Weeks:</label>
                                                                <div class="col-sm-10">
                                                                    <select id="getweeks" name="weeks" required
                                                                        style="width: 150px;">
                                                                        <option value="" hidden selected disabled>No. of
                                                                            Weeks</option>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" readonly=""
                                                                        placeholder="interest" id="figure"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:40px; border-radius: 10px;"
                                                                        class="btn btn-dark"
                                                                        href="get_loan_weekly.php">Reset</a>
                                                                </div>
