...
if (isset($_POST['pay'])) {
    ...
    if ($name != "") {
        ...
        $optional_interest = str_replace(",", "", $_POST['optional']);
...
//                         $parent = $parent2 - $interest_to_revenue;
            ...
            $intno = $_SESSION['intno'];
            $monthno = $_SESSION['monthno'];

            $monthly_interest = $interest / $monthno;
            $real_interest = $monthly_interest * $get_months;

            if ($optional_interest != "") {
                $real_interest = $optional_interest;
            }

            if ($pay_pen == "P") {
                $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date, month, year, collector) VALUES('$name monthly Penalty', 'penalty_monthly', 'monthly', '$parent2', '$date','$month','$year', 'admin')");

                $parent = $parent2;
                $real_interest = $parent2;
                //INSERT RECORD 1
                ...
                $sql_statement = "INSERT INTO monthly_allloan (name, type, remarks, repay, interest, codename, date, month, year, district, collector, timestamp, date_posted, bookmark_row) VALUES ('$name', '$loan_type', 'Penalty Paid', '$parent2', '0', '$telephone', '$date', '$month', '$year', '$regnum', 'admin', '$time_stamp1', '$date_posted', '$bookmark_row')";
                $result = mysqli_query($connect, $sql_statement);



                ////SUM INTEREST payment           
//                $interest_pay = mysqli_query($connect, "SELECT SUM(interest_pay) as total FROM monthly_allloan WHERE codename = '$telephone'");      
...
//                $interest_reduce  =  $interest - $sum_interest_pay;
                ...
                ////////////THIS IS TO SUM LOAN
                $code_loan = mysqli_query($connect, "SELECT SUM(disburseloan) as total, interest FROM monthly_allloan WHERE codename = '$telephone'");
                ...
                $sql_sum_repay = mysqli_query($connect, "UPDATE monthly_allloan SET repay_sum = '$summation_pay2', indbalance = '$balance' WHERE disburseloan > 1 AND codename='$telephone' AND remarks = 'loan disbursement'");
                ...
                $result222 = mysqli_query($connect, "UPDATE members SET monthlyindbal = '$balance', monthlyenddate = '$closingdate', monthlycode = '$telephone' WHERE namee = '$name'");
...
//    //echo $response;
                ...
                swal({
                         title: 'Success!',
                         text: '$name has successfully paid " . number_format($parent) . " Naira. " . number_format($real_interest) . " has been moved to revenue account',
                         icon: 'success',
                        buttons: {
                            confirm : {text:'Ok',className:'sweet-orange'},
                ...
                if ($bad_debt != "ON") {
                    $result_revenue = mysqli_query($connect, "INSERT INTO revenuexp (remaks, category, type, revenue, date, month, year, collector) VALUES('$name monthly interest', 'interest_monthly', 'monthly', '$real_interest', '$date','$month','$year', 'admin')");
                }
                ...
                swal({
                ...
                } else if (($bad_debt == "ON" && $parent2 < $final_total_insurance) || $bad_debt == "") {
                    ...
                    $bookmark_row = rand(10, 100000000);
                    $sql_statement = "INSERT INTO monthly_allloan (name, type, remarks, repay, interest, codename, date, date_format, month, year, district, collector, timestamp, insurance_out, date_posted, bookmark_row) VALUES ('$name', '$loan_type', '$remarks', '$parent2', '$real_interest', '$telephone', '$date' , '$date_format', '$month', '$year', '$regnum', 'admin', '$time_stamp1', '$insurance_out_now', '$date_posted', '$bookmark_row')";
                    $result = mysqli_query($connect, $sql_statement);
...
//                $interest_reduce  =  $interest - $sum_interest_pay;
                    ...
                    ///////THIS IS TO GET THE INDIVIDUAL BALANCE
                    ////////////THIS IS TO SUM LOAN
                    $code_loan = mysqli_query($connect, "SELECT SUM(disburseloan) as total, interest FROM monthly_allloan WHERE codename = '$telephone' AND (disburseloan > '1' OR disburseloan < -1)");
                    while ($row = mysqli_fetch_assoc($code_loan)) {
                        $summation_loan2 = $row['total'];
                        //                           $plus_interest = $row['interest'];  
                    }
                    ...
                    $balance = $summation_loan2 - $summation_pay2;
                    $sql_sum_repay = mysqli_query($connect, "UPDATE monthly_allloan SET repay_sum = '$summation_pay2', deposit = '0', indbalance = '$balance' WHERE disburseloan > 1 AND codename='$telephone' AND remarks = 'loan disbursement'");

                    $delete_monthly_deposit_table = mysqli_query($connect, "DELETE FROM monthly_deposit WHERE codename = '$telephone'");
                    ...
                    if ($result2 == true) {
                        ...
                        $sms_name = $name;
                        //    $sms_amt_disburseloan = number_format($amt_disburseloan); 
                        $sms_parent = number_format($parent2);
                        $sms_balance = number_format($balance);
                        $naija_code = "+234";
                        $phone = $naija_code . ltrim($tel, '0');
                        $curl = curl_init();
...
//    //echo $response;
                ...
                swal({
                         title: 'Success!',
                         text: '$name has successfully paid " . number_format($parent2) . " Naira.  " . number_format($real_interest) . "Naira has been moved to revenue account',
                         icon: 'success',
                        buttons: {
                            confirm : {text:'Ok',className:'sweet-orange'},
...
<head>
    <title>Monthly Payment of Loan</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">MONTHLY LOAN REPAYMENT</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>MONTHLY LOAN REPAYMENT</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">

                                                        <!--====================SEARCHING STUDENT-->
                                                        <form action="monthly_payment.php" method="POST"
                                                            ...
                                                            <center>
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        placeholder="Search Customer To Pay Loan with Codename"
                                                                        required="">
                                                            ...
                                                            $codename = $disburseloan = $dailypayment = $true = $available_blance = $check_codename = $tot_pay = "";
                                                            $get_name = $date = $images = $interest = $id = $name = $monthly_payment = $days_remaining = $remain_months = $remain_days = $regnum = $loan_type = $output_closedate = $closingdate = $address = $dob = $class = $parent = $telephone = $mail = $religion = $login_id = "";

                                                            if (isset($_POST['btnsrch'])) {


                                                                $codename = $_POST['telephone'];
                                                                $sql_state1 = "SELECT * FROM monthly_allloan WHERE  disburseloan > 1 AND remarks = 'loan disbursement' AND codename = '$codename'";
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($result1)) {
                                                                    ...
                                                                    $loan_type = $row["type"];
                                                                    $disburseloan_with_int = $row["disburseloan"];
                                                                ...
                                                                if ($check_codename != "") {
                                                                    ...
                                                                    $sql_state3 = "SELECT * FROM monthly_allloan WHERE name = '$name' AND codename = '$codename'";
                                                                    ...
                                                                    /////////THIS IS TO GET HOW MUCH SHOULD BE MONTHLY DAILY
                                                                    $monthly_payment = $disburseloan_with_int / $monthno;
                ...
                swal({
                        ...
                        closeOnClickOutside: false
                                                        ...
                                                        <form action="monthly_payment.php" method="POST"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Loan Collected"
                                                                                value="<?php echo @number_format($disburseloan_with_int); ?>"
                                                                                maxlength="12" readonly=""
                                                                                style="text-transform: uppercase;"
                                                                                required>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="<?php echo @number_format($available_blance); ?>"
                                                                                maxlength="12" readonly=""
                                                                                style="text-transform: uppercase;"
                                                                                required>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="loan_type"
                                                                                ...
                                                                                <option value="Monthly Payment">Monthly
                                                                                    Payment</option>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Select Months
                                                                    Paid For:</label>
                                                                <div class="col-sm-10">
                                                                    <select name="get_months" required>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="optional" id="" value=""
                                                                        placeholder="fill interest for Pre due date Payment (OTP only!!)"
                                                                        style="width: 300px;"
                                                                        onkeypress="return CheckNumeric()"
                                                                        onkeyup="FormatCurrency(this)">
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Montly
                                                                    Repayment:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="repay_plan"
                                                                        class="form-control"
                                                                        placeholder="Monthly Repayment"
                                                                        value="<?php echo @number_format($monthly_payment); ?>"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:40px; border-radius: 10px;"
                                                                        class="btn btn-dark"
                                                                        href="monthly_payment.php">Reset</a>
                                                                </div>
